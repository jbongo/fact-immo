...
<table style="height: 63px; width:90% ">
    <tbody>
        ...
        <tr style="">
            <td style="width: 48px;">&nbsp;</td>
            <td style=" ">{!! $avoir->description_produit !!} </td>
...
<table style="height: 47px; width: 672px;">
    <tbody>
        <tr>
            ...
            <td style="width: 100px; text-align:right;" >{{number_format($avoir->montant_ht,2,',',' ')}} &euro;</td>
        </tr>
        <tr>
            <td style="width: 400px;">&nbsp;</td>
            <td style="width: 160px;">T.V.A 20% :</td>
            <td style="width: 100px; text-align:right;" >{{number_format($avoir->montant_ht * App\Tva::tva(),2,',',' ')}} &euro;</td>
        </tr>
        <tr>
            <td style="width: 400px;">&nbsp;</td>
            <td style="width: 160px;">TOTAL T.T.C:</td>
            <td style="width: 100px; text-align:right;" >{{number_format($avoir->montant_ttc,2,',',' ')}} &euro;</td>
        </tr>
    </tbody>
</table>
<br>
...
<table style="height: 30px; width: 50%;">
    <tbody>
        <tr style="height: 25px;">
            ...
            <td style="width: 200px; height: 25px;">{{number_format($avoir->montant_ttc,2,'.',' ')}} &euro; TTC</td>
            <td style="width: 187px; height: 25px;"><span style="color: #ff0000; font-size:18px; font-weight:bold">&nbsp;R&eacute;f &agrave; rappeler: {{$avoir->numero}}</span></td>
        </tr>
    </tbody>
