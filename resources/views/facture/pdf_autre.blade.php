  <table style="width: 50%">
      <tbody>
          <tr>
              <td style="width: 320px;"><img src="https://www.stylimmo.com/images/logo.jpg" alt="" width="279"
                      height="124" /></td>
  ...
  <table style="height: 30px; width: 20%">
      <tbody>
          <tr>
              <td style="width: 216px;">Bagnols sur C&egrave;ze, le @if ($facture->date_facture != null)
                      {{ $facture->date_facture->format('d/m/Y') }} @else{{ $facture->created_at->format('d/m/Y') }}
                  @endif
              </td>
  ...
  <table style="height: 53px;" width="50%">
      <tbody>
          <tr>
              <td style="width: 443px;"><span style="color: #ff0000;">Merci d'indiquer le num&eacute;ro de facture en
                      r&eacute;f&eacute;rence du virement.</span></td>
              <td style="width: 344px;"><span style="text-decoration: underline;font-size:20px"><strong>FACTURE N&deg;
  ...
  <table style="height: 47px; width: 672px;">
      <tbody>
          <tr>
              ...
              <td style="width: 100px; text-align:right;">{{ number_format($facture->montant_ht, 2, ',', ' ') }} &euro;
              </td>
          </tr>
          <tr>
              <td style="width: 400px;">&nbsp;</td>
  ...
  <div class="footer">
          ...
          <tbody>
              <tr>
                  <td style="width: 170px;">
                      ...
                      <div><span style="text-decoration: underline;"><strong>Conditions de paiement:</strong></span>
                      </div>
                  ...
                  <td style="width: 488px;  font-size: 12px;">
                      ...
                      <div>A réception, par virement &agrave; la
                          SARL&nbsp;{{ App\Parametre::params()->raison_sociale }}, <br>en rappelant au moins sur
                          l'objet du virement les r&eacute;f&eacute;rences de la facture.</div>
              ...
              <tr>
                  <td style="width: 300px;">
                      ...
                      <div><span style="text-decoration: underline;"><strong>Indemnité forfaitaire de recouvrement:
                              </strong></span></div>
      ...
      <div style="text-align: center; font-size: 11px; margin-right: 5%; margin-left: 5%; ">
          <p><strong>SARL {{ App\Parametre::params()->raison_sociale }}</strong> -
              ...
              {{ App\Parametre::params()->code_postal }} {{ App\Parametre::params()->ville }} <br> Capital social:
              3000 € - Carte professionnelle N°1312T14 TVA {{ App\Parametre::params()->numero_tva }} - SIRET:
