...
<table style="height: 66px; width: 50%">
    <tbody>
        ...
        <tr>
            <td style="width: 48px;">&nbsp;</td>
            <td style="width: 428px;"><span style="text-decoration: underline;"><strong>Vendeur:</strong></span> &nbsp;&nbsp;&nbsp;&nbsp;<span style="color:mediumblue"> {{$compromis->nom_vendeur}} {{$compromis->prenom_vendeur}} </td>
            <td style="width: 391px;"></td>
        </tr>
        <tr>
            <td style="width: 48px;">&nbsp;</td>
            <td style="width: 228px;"><span style="text-decoration: underline;"><strong>Acquereur:</strong></span> &nbsp;&nbsp;&nbsp;&nbsp;<span style="color:mediumblue"> {{$compromis->nom_acquereur}} {{$compromis->prenom_acquereur}}</td>
            <td style="width: 391px;"></td>
        </tr>
    </tbody>
</table>
