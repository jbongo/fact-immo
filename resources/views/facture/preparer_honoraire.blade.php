                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-9 col-md-9 col-sm-9">
                                    <div class="form-group row">
                                        ...
                                        <input type="number" max="{{$mandataire->nb_mois_pub_restant}}"  class="form-control {{ $errors->has('nb_mois_deduire') ? ' is-invalid' : '' }}" value="{{old('nb_mois_deduire')}}" id="nb_mois_deduire" name="nb_mois_deduire" required >
