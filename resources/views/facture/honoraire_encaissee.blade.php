 ...
 @section('content')
     @section ('page_title')
        ...
        <hr>
     Affaires que j'ai encaissé en  {{$annee}} <br><hr>
                    ...
                    <div class="container-fluid">
                      ...
                      <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                        <ul class="nav navbar-nav">
                          <li class="active"><a href="{{route('facture.index_honoraire')}}"> <i class="material-icons" style="font-size: 15px;">account_balance_wallet</i> Factures Honoraires que j'ai encaissé en  {{$annee}}</a> <span class="sr-only">(current)</span></li>
