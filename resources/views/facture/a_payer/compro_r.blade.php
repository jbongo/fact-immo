    ...
    <div class="panel panel-info ">
        <div class="panel-body">
            <div class="table-responsive">
                <table id="example" class=" table student-data-table  table-striped table-hover  display  nowrap  "
                    style="width:100%">
                    <thead>
                    ...
                    @php  $grise = ""; @endphp
                    <tbody>
                        @foreach ($compromisR as $compromi)
                            @if ($compromi->getFactureStylimmo() != null && $compromi->getFactureStylimmo()->encaissee == 1)
                                <tr>
                                    <td>
                                    ...
                                    @if (Auth()->user()->role == 'admin')
                                        <td>
                                            <strong> <a
                                                    ...
                                                    {{ $compromi->user->prenom }}<i style="font-size: 17px"
                                    ...
                                    <td width="">
                                        @if ($compromi->getFactureStylimmo() != null && $compromi->facture_stylimmo_valide != 0)
                                            <a class="color-info" title="Télécharger la facture stylimmo"
                                                ...
                                                class="  m-b-10 m-l-5 "
                                                id="ajouter">{{ $compromi->getFactureStylimmo()->numero }} <i
                                            ...
                                            @if (Auth()->user()->role == 'admin')
                                                ...
                                                @else
                                                    <strong> <a data-toggle="tooltip"
                                                            title="@lang('Agence / Agent externe au réseau STYL\'IMMO') ">{{ $compromi->nom_agent }} </a>
                                                    </strong>
                                                @endif
                                            @else
                                                    ...
                                                    @if ($compromi->getPartage()->id == Auth()->user()->id)
                                                        <strong> <a>{{ $compromi->user->nom }}
                                                                {{ $compromi->user->prenom }} <span
                                                                    class="color-danger">
                                                                    ({{ $compromi->pourcentage_agent }} %) </span></a>
                                                        </strong>
                                                    @else
                                                        <strong> <a>{{ $compromi->getPartage()->nom }}
                                                                {{ $compromi->getPartage()->prenom }} <span
                                                                    class="color-danger">
                                        ...
                                        @if ($compromi->je_porte_affaire == 1 && $compromi->agent_id != Auth()->user()->id)
                                            @if ($compromi->demande_facture == 0)
                                                ...
                                                <span><a class="btn btn-default demander_facture"
                                                        ...
                                                        title="@lang('')">demander facture styl</a> </span>
                                    ...
                                    <td width="15%">
                                        ...
                                        @if ($compromi->cloture_affaire == 0 && $compromi->demande_facture == 2 && $compromi->agent_id != Auth()->user()->id)
                                            <a class="cloturer"
                                                ...
                                                data-toggle="tooltip" data-mandat="{{ $compromi->numero_mandat }}"
                                                title="@lang('Réitérer l\'affaire  ')">
                                                <img src="{{ asset('images/logo-notaire.png') }}" width="25px"
                                                    height="30px" alt="">
                                        ...
                                        @if (
                                            ...
                                            <span><a data-toggle="modal" id="{{ $compromi->id }}"
                                                    data-target="#myModal2" href="" class="archiver"
                                                    data-toggle="tooltip"
