                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6">
                        ...
                        <div class="form-group row">
                          ...
                          <div class="form-group row">
                               ...
                               <div class="col-lg-8 col-md-8 col-sm-8">
                                  <input type="date" class="form-control {{ $errors->has('date_achat') ? ' is-invalid' : '' }}" value="{{$article->date_achat->format('yy-m-d')}}" id="date_achat" name="date_achat" required placeholder=""  >
