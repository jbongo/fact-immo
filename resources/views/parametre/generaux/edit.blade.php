                                        ...
                                        <div class="col-lg-12 col-md-12 col-sm-12">
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-6" id="nb_jour_max_demande">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-4">
                                                        <input type="number" style="background-color:#f3f3f3" class="form-control" value="{{$parametre->nb_jour_max_demande}}" id="nb_jour_max_demande" name="nb_jour_max_demande" required >
                                                    </div>
                                                </div>
                                            </div>
