      ...
      <div class="card">
         ...
         <div class="card-body">
            <div class="form-validation">
               <form class="form-valide form-horizontal" action="{{ route('bareme_honoraire.store') }}" method="post">
                      {{ csrf_field() }}
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6">
                            <div class="form-group row">
                                ...
                                <div class="col-lg-8 col-md-8 col-sm-8">
                                   <input type="number" min="0" step="0.01" class="form-control {{$errors->has('prix_min') ? 'is-invalid' : ''}}" value="{{old('prix_min')}}" id="prix_min" name="prix_min" required>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6">
                            <div class="form-group row">
                                ...
                                <div class="col-lg-8 col-md-8 col-sm-8">
                                   <input type="number" min="0" step="0.01" class="form-control {{$errors->has('prix_max') ? 'is-invalid' : ''}}" value="{{old('prix_max')}}" id="prix_max" name="prix_max" required>
                    ...
                    <div class="row" id="div_forfait">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6">
                            <div class="form-group row">
                                ...
                                <div class="col-lg-8 col-md-8 col-sm-8">
                                   <input type="number" min="0" step="0.01" class="form-control {{$errors->has('forfait_min') ? 'is-invalid' : ''}}" value="{{old('forfait_min')}}" id="forfait_min" name="forfait_min" >
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6">
                            <div class="form-group row">
                                ...
                                <div class="col-lg-8 col-md-8 col-sm-8">
                                   <input type="number" min="0" step="0.01" class="form-control {{$errors->has('forfait_max') ? 'is-invalid' : ''}}" value="{{old('forfait_max')}}" id="forfait_max" name="forfait_max" >
                    ...
                    <div class="row" id="div_pourcentage">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6">
                            <div class="form-group row">
                                ...
                                <div class="col-lg-8 col-md-8 col-sm-8">
                                   <input type="number" min="0" step="0.01" class="form-control {{$errors->has('pourcentage') ? 'is-invalid' : ''}}" value="{{old('pourcentage')}}" id="pourcentage" name="pourcentage" >
