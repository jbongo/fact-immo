    ...
    <br>
        ...
        <div class="row">
            ...
            <div class="form-group row">
                ...
                <div class="col-lg-6 col-md-6">
                    <input type="text" class="form-control " value="{{old('titre_annonce_vente_terrain')}}" id="titre_annonce_vente_terrain" name="titre_annonce_vente_terrain"   >
                </div>
            </div>
        ...
        <div class="row">
            ...
            <div class="form-group row">
                <label class="col-lg-4 col-md-4 col-form-label" for="description_annonce_vente_terrain">@lang('Description de l\'annonce') <span class="text-danger">*xxx</span> </label>
                <div class="col-lg-6 col-md-6">
                   
                    <textarea class="form-control"  name="description_annonce_vente_terrain" id="description_annonce_vente_terrain" cols="30" rows="10" ></textarea>
    ...
    <div class="row">
        <div class="col-md-6 col-lg-6">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-6 col-md-6">
                                <input type="number" min="0"  class="form-control " value="{{old('surface_habitable_vente_terrain')}}" id="surface_habitable_vente_terrain" name="surface_habitable_vente_terrain" placeholder="@lang('m²')" > 
        ...
        <div class="col-md-6 col-lg-6">
                        <div class="form-group row">
                            ...
                            <div class="col-lg-6 col-md-6">
                                <select class="js-select2 form-control" id="val-pays" name="pays_vente_terrain" style="width: 100%;" data-placeholder="Choose one.." >
                        ...
                        <div class="form-group row">
                                ...
                                <div class="col-lg-6 col-md-6">
                                    <input type="text" class="form-control " value="{{old('ville_vente_terrain')}}" id="ville_vente_terrain" name="ville_vente_terrain"  >
                        ...
                        <div class="form-group row">
                                ...
                                <div class="col-lg-6 col-md-6">
                                    <input type="text" class="form-control " value="{{old('code_postal_vente_terrain')}}" id="code_postal_vente_terrain" name="code_postal_vente_terrain" placeholder=""  >
                            ...
                            <div class="col-lg-6 col-md-6">
                                ...
                                <div class="row">                                         
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-8 col-md-8">
                                            <input type="text"  class="form-control" value="{{old('numero_dossier_vente_terrain')}}" id="numero_dossier_vente_terrain" name="numero_dossier_vente_terrain" >
                                        </div>
                                    </div>                                    
                                </div>
                                <div class="row" id="div_date_creation_dossier_vente_terrain">                                         
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-8 col-md-8">
                                            <input type="date"  class="form-control " value="{{old('date_creation_dossier_vente_terrain') }}" id="date_creation_dossier_vente_terrain" name="date_creation_dossier_vente_terrain" >
                                        </div>
                                    </div>                                    
                                </div>
                                <hr>
