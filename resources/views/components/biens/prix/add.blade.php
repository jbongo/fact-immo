            ...
            <div class="media">
                ...
                <div class="p-10 media-body">
                    ...
                    <div class="progress progress-sm m-t-10 m-b-0">
                        <div class="progress-bar boxshadow-none  bg-dark" role="progressbar" aria-valuenow="100"
...
<div class="row">
    <div class="col-md-6 col-lg-6">
        <div style="text-align: center;">
            <label class="control-label" for="ajouter_proprietaire">Créer un nouveau propriétaire<span
                    class="text-danger">*</span></label>

            <input type="checkbox" unchecked data-toggle="toggle" id="ajouter_proprietaire" name="ajouter_proprietaire"
                data-off="Non" data-on="Oui" data-onstyle="success  btn-sm" data-offstyle="danger btn-sm">
        </div>
    </div>
</div>
...
<div class="row" id="ancien_proprietaire" style="margin-top: 30px">
    <div class="col-md-6 col-lg-6">
        <div class="form-group row" id="op1">
            <label class="control-label col-md-6 col-lg-6" for="proprietaire_id"> Selectionnez le propriétaire <span
                    class="text-danger">*</span> </label>
            <div class="col-lg-8">
...
<div id="nouveau_proprietaire" style="margin-top: 30px">
    ...
    <div class="row">
        ...
        <div class="col-lg-3 col-md-3 col-sm-3  ">
            <div class="form-group ">
                <label class="col-lg-8  col-md-8  col-sm-48 control-label" style="padding-top: 5px;"
                    for="type_contact1">Personne seule <span class="text-danger">*</span></label>
                <div class="col-lg-2 col-md-2 col-sm-2">
                    <input type="radio" style="height: 22px;" class="form-control" id="type_contact1"
                        name="nature_proprietaire" value="Personne seule" required>
        ...
        <div class="col-lg-3 col-md-3 col-sm-3  ">
            ...
            <div class="form-group ">
                <label class="col-lg-8 col-md-8 col-sm-8 control-label" style="padding-top: 5px;"
                    for="type_contact2">Personne morale <span class="text-danger">*</span></label>
                <div class="col-lg-2 col-md-2 col-sm-2">
                    <input type="radio" style="height: 22px;" class="form-control" id="type_contact2"
                        name="nature_proprietaire" value="Personne morale" required>
                    @if ($errors->has('nature_proprietaire'))
                        <br>
                        <div class="alert alert-warning ">
                            <strong>{{ $errors->first('nature_proprietaire') }}</strong>
        ...
        <div class="col-lg-3 col-md-3 col-sm-3 div_proprietaire ">
            ...
            <div class="form-group ">
                <label class="col-lg-8 col-md-8 col-sm-8 control-label" style="padding-top: 5px;"
                    for="type_contact3">Couple <span class="text-danger">*</span></label>
                <div class="col-lg-2 col-md-2 col-sm-2">
                    <input type="radio" style="height: 22px;" class="form-control" id="type_contact3"
                        name="nature_proprietaire" value="Couple" required>
                    @if ($errors->has('nature_proprietaire'))
                        <br>
                        <div class="alert alert-warning ">
                            <strong>{{ $errors->first('nature_proprietaire') }}</strong>
        ...
        <div class="col-lg-3 col-md-3 col-sm-3  ">
            ...
            <div class="form-group ">
                <label class="col-lg-8 col-md-8 col-sm-8 control-label" style="padding-top: 5px;"
                    for="type_contact4">Groupe <span class="text-danger">*</span></label>
                <div class="col-lg-2 col-md-2 col-sm-2">
                    <input type="radio" style="height: 22px;" class="form-control" id="type_contact4"
                        name="nature_proprietaire" value="Groupe" required>
                    @if ($errors->has('nature_proprietaire'))
                        <br>
                        <div class="alert alert-warning ">
                            <strong>{{ $errors->first('nature_proprietaire') }}</strong>
    ...
    <div class="row">
        ...
        <div class="col-lg-6 col-md-6 col-sm-6">
            ...
            <div class="form-group div_personne_couple">
                <label class="col-lg-4 col-md-4 col-sm-4 control-label" for="civilite1">@lang('Civilité') <span
                        class="text-danger">*</span></label>
            ...
            <div class="form-group div_personne_couple">
                <label class="col-lg-4 col-md-4 col-sm-4 control-label" for="nom1">Nom <span
                        class="text-danger">*</span></label>
                <div class="col-lg-8 col-md-8 col-sm-8">
                    <input type="text" class="form-control " value="{{ old('nom1_proprietaire') }}"
                        id="nom1" name="nom1_proprietaire" required>
            ...
            <div class="form-group div_personne_couple">
                <label class="col-lg-4 col-md-4 col-sm-4 control-label" for="prenom1">Prénom <span
                        class="text-danger">*</span></label>
                <div class="col-lg-8 col-md-8 col-sm-8">
                    <input type="text" class="form-control" value="{{ old('prenom1_proprietaire') }}"
                        id="prenom1" name="prenom1_proprietaire" required>
            ...
            <div class="form-group div_personne_couple">
                ...
                <div class="col-lg-8 col-md-8 col-sm-8">
                    <input type="text" class="form-control" id="email1"
                        value="{{ old('email1_proprietaire') }}" name="email1_proprietaire" required>
            ...
            <div class="form-group div_personne_couple">
                <label class="col-lg-4 col-md-4 col-sm-4 control-label" for="telephone_mobile1">Téléphone mobile
                </label>
                <div class="col-lg-8 col-md-8 col-sm-8">
                    <input type="text" class="form-control " value="{{ old('telephone_mobile1_proprietaire') }}"
                        id="telephone_mobile1" name="telephone_mobile1_proprietaire">
            ...
            <div class="form-group div_personne_couple">
                ...
                <div class="col-lg-8 col-md-8 col-sm-8">
                    <input type="text" class="form-control " value="{{ old('telephone_fixe1_proprietaire') }}"
                        id="telephone_fixe1" name="telephone_fixe1_proprietaire">
            ...
            <div class="form-group div_personne_seule">
                <label class="col-lg-4 col-md-4 col-sm-4 control-label" for="civilite">@lang('Civilité') <span
                        class="text-danger">*</span></label>
                <div class="col-lg-8 col-md-8 col-sm-8">
                    <select class="js-select2 form-control " id="civilite" name="civilite_proprietaire"
                        style="width: 100%;" required>
            ...
            <div class="form-group div_personne_seule">
                <label class="col-lg-4 col-md-4 col-sm-4 control-label" for="nom">Nom <span
                        class="text-danger">*</span></label>
                <div class="col-lg-8 col-md-8 col-sm-8">
                    <input type="text" class="form-control " value="{{ old('nom_proprietaire') }}"
                        id="nom" name="nom_proprietaire" required>
            ...
            <div class="form-group div_personne_seule">
                <label class="col-lg-4 col-md-4 col-sm-4 control-label" for="prenom">Prénom <span
                        class="text-danger">*</span></label>
                <div class="col-lg-8 col-md-8 col-sm-8">
                    <input type="text" class="form-control" value="{{ old('prenom') }}" id="prenom"
                        name="prenom_proprietaire" required>
            ...
            <div class="form-group div_personne_morale">
                <label class="col-lg-4 col-md-4 col-sm-4  control-label" for="forme_juridique">Forme juridique<span
                        class="text-danger">*</span></label>
                <div class="col-lg-8 col-md-8 col-sm-8">
                    <select class="js-select2 form-control" id="forme_juridique" name="forme_juridique_proprietaire"
                        style="width: 100%;" required>
                        <option value="{{ old('forme_juridique_proprietaire') }}">
                            {{ old('forme_juridique_proprietaire') }}</option>
                        ...
                        <option value="EIRL">EIRL - Entreprise individuelle à responsabilité limitée (01.01.2010)
                        </option>
            ...
            <div class="form-group div_personne_morale">
                <label class="col-lg-4 col-md-4 col-sm-4 control-label" for="raison_sociale">Raison sociale <span
                        class="text-danger">*</span></label>
                <div class="col-lg-8 col-md-8 col-sm-8">
                    <input type="text" class="form-control" value="{{ old('raison_sociale_proprietaire') }}"
                        id="raison_sociale" name="raison_sociale_proprietaire" required>
            ...
            <div class="form-group div_personne_groupe">
                <label class="col-lg-4 col-md-4 col-sm-4 control-label" for="nom_groupe">Nom du groupe <span
                        class="text-danger">*</span></label>
                <div class="col-lg-8 col-md-8 col-sm-8">
                    <input type="text" class="form-control" value="{{ old('nom_groupe_proprietaire') }}"
                        id="nom_groupe" name="nom_groupe_proprietaire" required>
            ...
            <div id="source_div">
                <div class="form-group div_personne_groupe">
                    <label class="col-lg-4 col-md-4 col-sm-4 control-label" for="type_groupe">Type de groupe</label>
                    <div class="col-lg-8">
                        <select class="selectpicker col-lg-6" id="type_groupe" name="type_groupe_proprietaire"
            ...
            <div id="source_div">
                <div class="form-group row">
                    ...
                    <div class="col-lg-8">
                        <select class="selectpicker col-lg-6" id="source_id" name="source_id_proprietaire"
        ...
        <div class="col-lg-6 col-md-6 col-sm-6">
            ...
            <div class="form-group div_personne_couple">
                <label class="col-lg-4 col-md-4 col-sm-4 control-label" for="civilite2">@lang('Civilité') <span
                        class="text-danger">*</span></label>
                <div class="col-lg-8 col-md-8 col-sm-8">
                    <select class="js-select2 form-control " id="civilite2" name="civilite2_proprietaire"
                        style="width: 100%;" required>
            ...
            <div class="form-group div_personne_couple">
                <label class="col-lg-4 col-md-4 col-sm-4 control-label" for="nom2">Nom <span
                        class="text-danger">*</span></label>
                <div class="col-lg-8 col-md-8 col-sm-8">
                    <input type="text" class="form-control " value="{{ old('nom2_proprietaire') }}"
                        id="nom2" name="nom2_proprietaire" required>
            ...
            <div class="form-group div_personne_couple">
                <label class="col-lg-4 col-md-4 col-sm-4 control-label" for="prenom2">Prénom <span
                        class="text-danger">*</span></label>
                <div class="col-lg-8 col-md-8 col-sm-8">
                    <input type="text" class="form-control" value="{{ old('prenom2_proprietaire') }}"
                        id="prenom2" name="prenom2_proprietaire" required>
            ...
            <div class="form-group div_personne_couple">
                ...
                <div class="col-lg-8 col-md-8 col-sm-8">
                    <input type="text" class="form-control" id="email2"
                        value="{{ old('email2_proprietaire') }}" name="email2_proprietaire" required>
            ...
            <div class="form-group div_personne_couple">
                <label class="col-lg-4 col-md-4 col-sm-4 control-label" for="telephone_mobile2">Téléphone mobile
                </label>
                <div class="col-lg-8 col-md-8 col-sm-8">
                    <input type="text" class="form-control " value="{{ old('telephone_mobile2_proprietaire') }}"
                        id="telephone_mobile2" name="telephone_mobile2_proprietaire">
            ...
            <div class="form-group div_personne_couple">
                ...
                <div class="col-lg-8 col-md-8 col-sm-8">
                    <input type="text" class="form-control " value="{{ old('telephone_fixe2_proprietaire') }}"
                        id="telephone_fixe2" name="telephone_fixe2_proprietaire">
            ...
            <div class="form-group div_personne_tout">
                ...
                <div class="col-lg-8 col-md-8 col-sm-8">
                    <input type="text" class="form-control" id="email"
                        value="{{ old('email_proprietaire') }}" name="email_proprietaire" required>
            ...
            <div class="form-group div_personne_tout">
                <label class="col-lg-4 col-md-4 col-sm-4 control-label" for="telephone_mobile">Téléphone mobile
                </label>
                <div class="col-lg-8 col-md-8 col-sm-8">
                    <input type="text" class="form-control " value="{{ old('telephone_mobile_proprietaire') }}"
                        id="telephone_mobile" name="telephone_mobile_proprietaire">
            ...
            <div class="form-group div_personne_tout">
                ...
                <div class="col-lg-8 col-md-8 col-sm-8">
                    <input type="text" class="form-control " value="{{ old('telephone_fixe_proprietaire') }}"
                        id="telephone_fixe" name="telephone_fixe_proprietaire">
            ...
            <div class="form-group div_personne_morale ">
                ...
                <div class="col-lg-8 col-md-8 col-sm-8">
                    <input type="text" id="numero_siret" class="form-control "
                        value="{{ old('numero_siret_proprietaire') }}" name="numero_siret_proprietaire">
            ...
            <div class="form-group div_personne_morale ">
                ...
                <div class="col-lg-8 col-md-8 col-sm-8">
                    <input type="text" id="numero_tva" class="form-control "
                        value="{{ old('numero_tva_proprietaire') }}" name="numero_tva_proprietaire">
    ...
    <div class="row">
        ...
        <div class="col-lg-6 col-md-6 col-sm-6">
            ...
            <div class="form-group row">
                ...
                <div class="col-lg-8 col-md-8 col-sm-8">
                    <input type="text" class="form-control " value="{{ old('adresse_proprietaire') }}"
                        id="adresse_proprietaire" name="adresse_proprietaire">
            ...
            <div class="form-group row">
                <label class="col-lg-4 col-md-4 col-sm-4 control-label" for="code_postal_proprietaire">Code postal
                </label>
                <div class="col-lg-8 col-md-8 col-sm-8">
                    <input type="text" class="form-control" value="{{ old('code_postal_proprietaire') }}"
                        id="code_postal_proprietaire" name="code_postal_proprietaire">
            ...
            <div class="form-group row">
                ...
                <div class="col-lg-8 col-md-8 col-sm-8">
                    <input type="text" class="form-control" value="{{ old('ville_proprietaire') }}"
                        id="ville_proprietaire" name="ville_proprietaire">
            ...
            <div class="form-group row">
                ...
                <div class="col-lg-8 col-md-8 col-sm-8">
                    <input type="text" class="form-control"
                        value="{{ old('pays_proprietaire') ? old('pays_proprietaire') : 'France' }}"
                        id="pays_proprietaire" value="France" name="pays_proprietaire"
...
<div class="row">
    <div class="col-md-6 col-lg-6">
        ...
        <div class="form-group row">
            <label class="col-lg-4 col-md-4 col-sm-4 control-label" for="numero_mandat">Numéro Mandat <span
                    class="text-danger">*</span> </label>
            <div class="col-lg-6 col-md-6 col-sm-6">
                <input type="text" class="form-control" value="{{ old('numero_mandat') }}"
                    id="numero_mandat"required name="numero_mandat">
        ...
        <div class="form-group row">
            <label class="col-lg-4 col-md-4 col-form-label" for="taxe_habitation_info_fin">type <span
                    class="text-danger">*</span> </label>
        ...
        <div class="form-group row">
            <label class="col-lg-4 col-md-4 col-form-label" for="tacite_reconduction_mandat">Tacite reconduction
            </label>
            <div class="col-lg-6 col-md-6">
                <select name="tacite_reconduction_mandat" id="tacite_reconduction_mandat" class="form-control "
                    required>
    ...
    <div class="col-md-6 col-lg-6">
        ...
        <div class="form-group row">
            ...
            <div class="col-lg-6 col-md-6 col-sm-6">
                <input type="date" class="form-control" value="{{ old('date_debut_mandat') }}"
                    id="date_debut_mandat" name="date_debut_mandat">
        ...
        <div class="form-group row">
            ...
            <div class="col-lg-6 col-md-6 col-sm-6">
                <input type="date" class="form-control" value="{{ old('date_fin_mandat') }}"
                    id="date_fin_mandat" name="date_fin_mandat">
        ...
        <div class="form-group row">
            <label class="col-lg-4 col-md-4 col-form-label" for="duree_irrevocabilite_mandat">Durée irrévocabilité
            </label>
            <div class="col-lg-6 col-md-6">
                <input type="text" class="form-control " id="duree_irrevocabilite_mandat"
                    name="duree_irrevocabilite_mandat">
...
<div class="row">
    <div class="col-md-12 col-lg-12">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-8 col-md-8">
                            <input type="number" required min="0" class="form-control "
                                id="prix_net_info_fin" name="prix_net_info_fin" placeholder="@lang('€')">
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="form-group row">
                        <label class="col-lg-4 col-md-4 col-form-label" for="prix_public_info_fin">@lang('Public (€)')
                            <span class="text-danger">*</span></label>
                        <div class="col-lg-8 col-md-8">
                            <input type="number" min="0" required class="form-control "
                                id="prix_public_info_fin" name="prix_public_info_fin"
                                placeholder="@lang('€')">
                        </div>
                    </div>
                </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-4 col-md-4">
                                <input type="number" min="0" class="form-control "
                                    id="part_vendeur_info_fin" name="part_vendeur_info_fin"
                                    placeholder="@lang('€')">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-lg-4 col-md-4 col-form-label" for="taux_net_info_fin">@lang('Taux Net Vendeur %')
                            </label>
                            <div class="col-lg-4 col-md-4">
        ...
        <div class="div_prix_location">
            ...
            <div class="row">
                <div class="form-group row">
                    <label class="col-lg-4 col-md-4 col-form-label" for="loyer">@lang('Loyer (€)') <span
                            class="text-danger">*</span> </label>
                    <div class="col-lg-8 col-md-8">
                        <input type="number" required min="0" class="form-control " id="loyer"
                            name="loyer" placeholder="@lang('€')">
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="form-group row">
                    <label class="col-lg-4 col-md-4 col-form-label" for="complement_loyer">@lang('Complément Loyer €') <span
                            class="text-danger">*</span></label>
                    <div class="col-lg-8 col-md-8">
                        <input type="number" min="0" required class="form-control " id="complement_loyer"
                            name="complement_loyer" placeholder="@lang('€')">
                    </div>
                </div>
            </div>
            <div class="row">
            ...
            {{-- <div class="row">
                ...
                <div class="row" id="div_part_locataire">
                    <div class="form-group row">
                        <label class="col-lg-4 col-md-4 col-form-label"
                            for="part_acquereur_info_fin">@lang('Montant €') </label>
                        <div class="col-lg-4 col-md-4">
                            <input type="number" min="0" class="form-control " id="part_acquereur_info_fin"
                                name="part_acquereur_info_fin" placeholder="@lang('€')">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-lg-4 col-md-4 col-form-label" for="taux_prix_info_fin">@lang('Pourcentage %')
                        </label>
                        <div class="col-lg-4 col-md-4">
            ...
            <div class="row">
                <div class="form-group row">
                    <label class="col-lg-4 col-md-4 col-form-label"
                        for="honoraire_vendeur_info_fin">@lang('Part Propriétaire') </label>
                    <div class="col-lg-8 col-md-8">
                        <label class="radio-inline"><input type="radio" checked value="@lang('Non')"
                ...
                <div class="row" id="div_part_proprietaire">
                    <div class="form-group row">
                        <label class="col-lg-4 col-md-4 col-form-label" for="part_vendeur_info_fin">@lang('Montant €')
                        </label>
                        <div class="col-lg-4 col-md-4">
                            <input type="number" min="0" class="form-control " id="part_vendeur_info_fin"
                                name="part_vendeur_info_fin" placeholder="@lang('€')">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-lg-4 col-md-4 col-form-label" for="taux_net_info_fin">@lang('Pourcentage %')
                        </label>
                        <div class="col-lg-4 col-md-4">
                            <input type="number" min="0" class="form-control " id="taux_net_info_fin"
                                name="taux_net_info_fin" placeholder="@lang('%')">
...
<div class="row">
    <div class="col-md-6 col-lg-6">
            ...
            <div class="col-lg-6 col-md-6">
                ...
                <div class="row">
                    <div class="form-group row">
                        ...
                        <div class="col-lg-8 col-md-8">
                            <input type="number" min="0" class="form-control "
                                value="{{ old('estimation_valeur_info_fin') }}" id="estimation_valeur_info_fin"
                ...
                <div class="row">
                    <div class="form-group row">
                        ...
                        <div class="col-lg-8 col-md-8">
                            <input type="date" class="form-control " id="estimation_date_info_fin"
                                name="estimation_date_info_fin" placeholder="">
                        </div>
                    </div>
                </div>
                <hr>
            ...
            <div class="col-lg-6 col-md-6">
                ...
                <div class="row">
                    <div class="form-group row">
                        ...
                        <div class="col-lg-8 col-md-8">
                            <input type="number" min="0" class="form-control "
                                value="{{ old('viager_valeur_info_fin') }}" id="viager_valeur_info_fin"
                ...
                <div class="row">
                    <div class="form-group row">
                        ...
                        <div class="col-lg-8 col-md-8">
                            <input type="number" min="0" class="form-control "
                                value="{{ old('viager_rente_mensuelle_info_fin') }}"
                                id="viager_rente_mensuelle_info_fin" name="viager_rente_mensuelle_info_fin">
                        </div>
                    </div>
                </div>
                <hr>
        ...
        <div class="form-group row">
            <label class="col-lg-4 col-md-4 col-form-label" for="travaux_a_prevoir_info_fin">@lang('Travaux à prévoir')
            </label>
            <div class="col-lg-6 col-md-6">
                <input type="text" class="form-control " id="travaux_a_prevoir_info_fin"
                    name="travaux_a_prevoir_info_fin">
        ...
        <div class="form-group row">
            ...
            <div class="col-lg-6 col-md-6">
                <input type="number" min="0" class="form-control " id="depot_garanti_info_fin"
                    name="depot_garanti_info_fin" placeholder="@lang('€')">
        ...
        <div class="form-group row">
            ...
            <div class="col-lg-6 col-md-6">
                <input type="number" min="0" class="form-control " id="taxe_habitation_info_fin"
                    name="taxe_habitation_info_fin" placeholder="@lang('€')">
        ...
        <div class="form-group row">
            ...
            <div class="col-lg-6 col-md-6">
                <input type="number" min="0" class="form-control " id="taxe_fonciere_info_fin"
                    name="taxe_fonciere_info_fin" placeholder="@lang('€')">
    ...
    <div class="col-md-6 col-lg-6">
        ...
        <div class="row div_prix_vente">
            <label class="col-lg-4 col-md-4 col-form-label" for="charge_mensuelle_total_info_fin">@lang('Charges Mensuelles')
            </label>
            <div class="col-lg-6 col-md-6">
                ...
                <div class="row">
                    <div class="form-group row">
                        ...
                        <div class="col-lg-8 col-md-8">
                            <input type="number" min="0" class="form-control "
                                id="charge_mensuelle_total_info_fin" name="charge_mensuelle_total_info_fin"
                                placeholder="@lang('€')">
                        </div>
                    </div>
                </div>
        ...
        <div class="row div_prix_location">
            <label class="col-lg-4 col-md-4 col-form-label" for="charge_mensuelle_total_info_fin">@lang('Charges Locatives')
            </label>
            <div class="col-lg-6 col-md-6">
                <div class="row">
                    <div class="form-group row">
            ...
            <div class="form-group row">
                <label class="col-lg-4 col-md-4 col-form-label"
                    for="charge_mensuelle_total_info_fin">@lang('Durée du bail (mois)') </label>
                <div class="col-lg-8 col-md-8">
                    <input type="number" min="0" class="form-control " id="charge_mensuelle_total_info_fin"
                        name="charge_mensuelle_total_info_fin" placeholder="mois">
                </div>
            </div>
