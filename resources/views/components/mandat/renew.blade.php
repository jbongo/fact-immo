<div class="modal fade" id="mandat_renew" data-backdrop="static" tabindex="-1" role="dialog"
            ...
            <div class="modal-body">
                <div class="panel lobipanel-basic panel-warning">
                    ...
                    <div class="panel-body">
                        La prolongation ou la reconduction tacite d'un mandat expiré implique l'accord du mandant au
                        préalable, assurez vous d'avoir cet accord avant de prolonger le mandat.
                    </div>
                </div>
                <br>
                <div class="form-validation">
                    <form class="form-appel form-horizontal form-valid-mandat"
                        action="{{ route('mandat.renew', Crypt::encrypt($mandat->id)) }}" method="post">
                        @csrf
                        <div class="form-group row @if ($errors->has('duration')) has-error @endif">
                            ...
                            <div class="col-lg-3">
                                <input type="number" min="3" max="36" value="3" id="duration"
