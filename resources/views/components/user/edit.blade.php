<div class="modal fade" id="user_edit" data-backdrop="static" tabindex="-1" role="dialog"
                ...
                <div class="form-validation">
                    <form class="form-appel form-horizontal"
                        ...
                        <div class="form-group row">
                            <label class="col-sm-4 control-label" for="civilite">Civilité<span
                        ...
                        <div class="form-group row @if ($errors->has('nom')) has-error @endif">
                            <label class="col-sm-4 control-label" for="nom">Nom<span
                                    class="text-danger">*</span></label>
                            <div class="col-lg-3">
                                <input type="text" id="nom" class="form-control" value="{{ $info->nom }}"
                                    name="nom" placeholder="Ex: LEMAIRE..." required>
                                @if ($errors->has('nom'))
                                    <br>
                        ...
                        <div class="form-group row @if ($errors->has('prenom')) has-error @endif">
                            <label class="col-sm-4 control-label" for="prenom">Prenom<span
                                    class="text-danger">*</span></label>
                            <div class="col-lg-3">
                                <input type="text" id="prenom" class="form-control" value="{{ $info->prenom }}"
                                    name="prenom" placeholder="Ex: Julie..." required>
                        ...
                        <div class="form-group row @if ($errors->has('code_postal')) has-error @endif">
                            <label class="col-sm-4 control-label" for="code_postal">Code postal<span
                                    class="text-danger">*</span></label>
                            <div class="col-lg-2">
                                <input type="text" id="code_postal" class="form-control"
                                    value="{{ $info->code_postal }}" name="code_postal" placeholder="Ex: 75001..."
                                    required>
                        ...
                        <div class="form-group row @if ($errors->has('ville')) has-error @endif">
                            <label class="col-sm-4 control-label" for="ville">Ville<span
                                    class="text-danger">*</span></label>
                            <div class="col-lg-3">
                                <input type="text" id="ville" class="form-control" value="{{ $info->ville }}"
                                    name="ville" placeholder="Ex: Paris..." required>
                                @if ($errors->has('ville'))
                                    <br>
                                    <div class="alert alert-warning ">
                                        <a href="#" class="close" data-dismiss="alert"
                        ...
                        <div class="form-group row @if ($errors->has('adresse')) has-error @endif">
                            <label class="col-sm-4 control-label" for="adresse">Adresse<span
                                    class="text-danger">*</span></label>
                            <div class="col-lg-4">
                                <input type="text" id="adresse" class="form-control"
                                    value="{{ $info->adresse }}" name="adresse" placeholder="Ex: 1 Rue Rivoli..."
                                    required>
                        ...
                        <div class="form-group row @if ($errors->has('email')) has-error @endif">
                            <label class="col-sm-4 control-label" for="email">Email<span
                                    class="text-danger">*</span></label>
                            <div class="col-lg-3">
                                <input type="email" id="email"
                                    class="form-control {{ $errors->has('email') ? 'is-invalid' : '' }}"
                                    value="{{ $info->email }}" name="email"
                                    placeholder="Ex: contact@gmail.com..." required>
                                @if ($errors->has('email'))
                                    <br>
                                    <div class="alert alert-warning ">
                                        <a href="#" class="close" data-dismiss="alert"
                        ...
                        <div class="form-group row @if ($errors->has('telephone')) has-error @endif">
                            <label class="col-sm-4 control-label" for="telephone">Téléphone<span
                                    class="text-danger">*</span></label>
                            <div class="col-lg-2">
                                <input type="text" id="telephone"
                                    class="form-control {{ $errors->has('telephone') ? 'is-invalid' : '' }}"
                                    value="{{ $info->telephone }}" name="telephone" placeholder="Ex: 0600000000..."
                                    required>
