                            ...
                            <div class="contact-information">
                                <div class="phone-content">
                                    ...
                                    <span class="phone-number"><span
                                            class="badge badge-dark">{{ $bien->type_bien }}</span></span>
                                </div>
                                ...
                                <div class="skype-content">
                                    ...
                                    <span
                                        class="contact-skype">{{ $bien->adresse_bien . ' ' . $bien->code_postal . ' ' . $bien->ville }}</span>
                                </div>
                                <div class="skype-content">
                                    <span class="contact-title"><strong>DPE:</strong></span>
                                    <span class="contact-skype"><span
                                            class="badge badge-warning">{{ $bien->biendetail->diagnostic_dpe_consommation }}</span></span>
                                </div>
                                <div class="skype-content">
                                    <span class="contact-title"><strong>GES:</strong></span>
                                    <span class="contact-skype"><span
                                            class="badge badge-pink">{{ $bien->biendetail->diagnostic_dpe_ges }}</span></span>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div role="tabpanel" class="tab-pane active" id="1">
                            <div class="contact-information">
                                <div class="phone-content">
                                    ...
                                    <span class="phone-number">{{ $bien->mandat->numero }}</span>
                                </div>
                                <div class="address-content">
                                    <span class="contact-title"><strong>Date de signature:</strong></span>
                                    <span
                                        class="mail-address">{{ date('d-m-Y', strtotime($bien->mandat->date_debut)) }}</span>
                                </div>
                                <div class="email-content">
                                    <span class="contact-title"><strong>Type de mandat:</strong></span>
                                    <span class="contact-email"><span
                                            class="badge badge-info">{{ $bien->mandat->type }}</span></span>
                                </div>
                                <div class="website-content">
                                ...
                                <div class="skype-content">
                                    ...
                                    <span class="contact-skype"><span
                                            class="badge badge-info">{{ $compromis->charge }}</span></span>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="panel lobipanel-basic panel-info">
            ...
            <div class="panel-body">
                <div class="user-profile">
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="user-job-title"><span
                                    class="badge badge-danger">{{ $mandant->sous_type }}</span></div>
                            @if ($mandant->sous_type === 'personne_morale')
                                <div class="custom-tab user-profile-tab">
                                    <ul class="nav nav-tabs" role="tablist">
                                        <li role="presentation" class="active"><a href="#1" aria-controls="1"
                                                role="tab" data-toggle="tab">Informations entité</a></li>
                                    </ul>
                                    <div class="tab-content">
                                        <div role="tabpanel" class="tab-pane active" id="1">
                                            <div class="contact-information">
                                                <div class="website-content">
                                                    ...
                                                    <span class="contact-website"><span
                                                            class="badge badge-info">{{ $mandant->forme_juridique }}</span></span>
                                                </div>
                                                <div class="phone-content">
                                                ...
                                                <div class="address-content">
                                                    ...
                                                    <span
                                                        class="mail-address">{{ $mandant->adresse . ' ' . $mandant->code_postal . ' ' . $mandant->ville }}</span>
                                                </div>
                                                <div class="skype-content">
                ...
                <div class="user-profile">
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="custom-tab user-profile-tab">
                                <ul class="nav nav-tabs" role="tablist">
                                    <li role="presentation" class="active"><a href="#tb1" aria-controls="1"
                                            role="tab" data-toggle="tab">Liste des personnes</a></li>
                                </ul>
                                <div class="tab-content">
                                            ...
                                            <table class="table table-hover table-striped">
                                                ...
                                                <tbody>
                                                    @foreach ($mandant->individus as $one)
                                                        <tr>
                                                            <th scope="row"><span
                                                                    class="badge badge-pink">{{ $one->civilite }}</span>
                                                                <strong>{{ $one->nom . ' ' . $one->prenom }}</strong></th>
                                                            <td><strong
                                                                    class="color-info">{{ $one->email }}</strong><br>
            ...
            <div class="panel-body">
                <div class="user-profile">
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="user-job-title"><span
                                    class="badge badge-danger">{{ $acquereur->sous_type }}</span></div>
                            @if ($mandant->sous_type === 'personne_morale')
                                <div class="custom-tab user-profile-tab">
                                    <ul class="nav nav-tabs" role="tablist">
                                        <li role="presentation" class="active"><a href="#tet1" aria-controls="1"
                                                role="tab" data-toggle="tab">Informations entité</a></li>
                                    </ul>
                                    <div class="tab-content">
                                            ...
                                            <div class="contact-information">
                                                <div class="website-content">
                                                    <span class="contact-title"><strong>Forme
                                                            juridique:</strong></span>
                                                    <span class="contact-website"><span
                                                            class="badge badge-info">{{ $acquereur->forme_juridique }}</span></span>
                                                </div>
                                                <div class="phone-content">
                                                    <span class="contact-title"><strong>Raison sociale:</strong></span>
                                                ...
                                                <div class="address-content">
                                                    <span class="contact-title"><strong>Address:</strong></span>
                                                    <span
                                                        class="mail-address">{{ $acquereur->adresse . ' ' . $acquereur->code_postal . ' ' . $acquereur->ville }}</span>
                                                </div>
                                                <div class="skype-content">
                                                    <span class="contact-title"><strong>Téléphone:</strong></span>
                ...
                <div class="user-profile">
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="custom-tab user-profile-tab">
                                <ul class="nav nav-tabs" role="tablist">
                                    <li role="presentation" class="active"><a href="#tbrs" aria-controls="1"
                                            role="tab" data-toggle="tab">Liste des personnes</a></li>
                                </ul>
                                <div class="tab-content">
