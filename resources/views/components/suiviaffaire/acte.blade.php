...
@endphp
<div class="modal fade" id="gestion_acte" data-backdrop="static" tabindex="-1" role="dialog"
        ...
        <div class="modal-content">
            ...
            <div class="modal-body act18">
                <ul class="nav nav-pills nav-tabs">
                    <li class="act111 active"><a data-toggle="pill" href="#home_act"><i class="ti-folder"></i>
                            <strong>@lang('Liste des documents')</strong></a></li>
                    <li class="act222"><a data-toggle="pill" href="#nrvact1"><i class="ti-calendar"></i>
    ...
    <script>
        ...
        $("#submit_acte").on('click', function(rtf) {
            ...
            if (form.valid() == true) {
                ...
                $.ajax({
                    url: (
                        "{{ route('suiviaffaire.rdv', [Crypt::encrypt($bien->id), Crypt::encrypt('rendez_vous_acte')]) }}"
                        ),
                    type: 'POST',
                    data: {
        ...
        <script>
            ...
            $(".update_acte").on('click', function(orion) {
                ...
                if (form.valid() === true) {
                    $.ajax({
                        url: (
                            "{{ route('suiviaffaire.rdv.update', [Crypt::encrypt($bien->id), Crypt::encrypt('rendez_vous_acte')]) }}"
                            ),
                        type: 'POST',
                        data: {
