            ...
            <div class="modal-body">
                <div class="panel lobipanel-basic panel-warning">
                    ...
                    <div class="panel-body">
                        ...
                        si elle est acceptée par le mandant l'étape pour signer le compromis sera déclenchée
                        immédiatement.
                    </div>
                </div>
                <div class="form-validation">
                    <form class="form-appel form-horizontal form-visit"
                        action="{{ route('suiviaffaire.offre.add', Crypt::encrypt($bien->id)) }}" method="post">
                        @csrf
                        <div class="form-group row">
                            <label class="col-sm-4 control-label" for="entite_id">Associer l'acquéreur potentiel
                                (Entité)<span class="text-danger">*</span></label>
                            <div class="col-lg-4">
                                <select class="selectpicker col-lg-8" id="entite_id" name="entite_id"
                        ...
                        <div class="form-group row @if ($errors->has('montant')) has-error @endif">
                            <label class="col-sm-4 control-label" for="montant">Montant de l'offre TTC (€)<span
                        ...
                        <div class="form-group row @if ($errors->has('frais_agence')) has-error @endif">
                            <label class="col-sm-4 control-label" for="frais_agence">Frais d'agence (€)<span
                                    class="text-danger">*</span></label>
                            <div class="col-lg-3">
                        ...
                        <div class="form-group row @if ($errors->has('date_debut')) has-error @endif">
                            <label class="col-sm-4 control-label" for="date_debut">Date effective de l'offre <span
                                    class="text-danger">*</span></label>
                            <div class="col-lg-3">
                        ...
                        <div class="form-group row @if ($errors->has('date_expiration')) has-error @endif">
                            <label class="col-sm-4 control-label" for="date_expiration">Date de fin de l'offre<span
                                    class="text-danger">*</span></label>
                            <div class="col-lg-3">
                                <input type="date" id="date_expiration"
                                    class="form-control {{ $errors->has('date_expiration') ? 'is-invalid' : '' }}"
                                    value="{{ old('date_expiration') }}" name="date_expiration" required>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-sm-4 control-label" for="conditions_suspensives">Résumé des conditions
                                suspensives (à ajouter au compromis plus tard)</label>
                            <div class="col-lg-4">
                                <textarea rows="6" id="conditions_suspensives"
                                    class="form-control {{ $errors->has('conditions_suspensives') ? 'is-invalid' : '' }}"
                                    value="{{ old('conditions_suspensives') }}" name="conditions_suspensives"
                                    placeholder="Ex: Acceptation d'un pret bancaire..."></textarea>
                            </div>
                        </div>
...
<!--Duplicate offre-->
<div class="modal fade" id="offre_counter" data-backdrop="static" tabindex="-1" role="dialog"
    aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-body">
                <div class="panel lobipanel-basic panel-info">
                    ...
                    <div class="panel-body">
                        La contre offre permet de faire une nouvelle offre à partir d'une offre rejetée en changeant
                        seulement le montant et les frais d'agence.
                    </div>
                </div>
                <div class="form-validation">
                    <form class="form-horizontal form_contre_offre" action="#" method="post">
                        ...
                        <div class="form-group row @if ($errors->has('montant')) has-error @endif">
                            <label class="col-sm-4 control-label" for="montant">Montant de l'offre TTC (€)<span
                                    class="text-danger">*</span></label>
                            <div class="col-lg-3">
                                <input type="number" min="1" step="1" id="montant_counter"
                                    class="form-control {{ $errors->has('montant') ? 'is-invalid' : '' }}"
                                    value="{{ old('montant') }}" name="montant" required>
                            </div>
                        </div>
                        <div class="form-group row @if ($errors->has('frais_agence')) has-error @endif">
                            <label class="col-sm-4 control-label" for="frais_agence">Frais d'agence (€)<span
                                    class="text-danger">*</span></label>
                            <div class="col-lg-3">
                                <input type="number" min="1" step="1" id="frais_agence_counter"
                                    class="form-control {{ $errors->has('frais_agence') ? 'is-invalid' : '' }}"
                                    value="{{ old('frais_agence') }}" name="frais_agence" required>
                            </div>
                        </div>
                        <div class="form-group row @if ($errors->has('date_debut')) has-error @endif">
                            <label class="col-sm-4 control-label" for="date_debut">Date effective de l'offre <span
                                    class="text-danger">*</span></label>
                            <div class="col-lg-3">
                                <input type="date" id="date_debut_counter"
                                    class="form-control {{ $errors->has('date_debut') ? 'is-invalid' : '' }}"
                                    value="{{ old('date_debut') }}" name="date_debut" required>
                            </div>
                        </div>
                        <div class="form-group row @if ($errors->has('date_expiration')) has-error @endif">
                            <label class="col-sm-4 control-label" for="date_expiration">Date de fin de l'offre<span
                                    class="text-danger">*</span></label>
                            <div class="col-lg-3">
                                <input type="date" id="date_expiration_counter"
                                    class="form-control {{ $errors->has('date_expiration') ? 'is-invalid' : '' }}"
                                    value="{{ old('date_expiration') }}" name="date_expiration" required>
                            </div>
                        </div>
