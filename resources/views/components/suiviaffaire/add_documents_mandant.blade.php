<div class="modal fade" id="documents_mandant_add" data-backdrop="static" tabindex="-1" role="dialog"
            ...
            <div class="modal-body">
                <div class="panel lobipanel-basic panel-warning">
                    ...
                    <div class="panel-body">
                        Définnir la liste des documents justificatifs que le vendeur doit réunir pour la signature du
                        ...
                        disponibilité par le mandant ou le cas echean, sa réception, vous pouvez ajouter jusqu'à 10
                        documents à la fois.
                    </div>
                </div>
                <div class="form-validation">
                    <form class="form-appel form-horizontal doc_mdn_push" action="#" method="post">
                        @csrf
                        <button id="add_field_documents_mandant"
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="submit" id="dcm_mdn_check"
            ...
            $('#dcm_mdn_check').click(function(e) {
                ...
                if (form.valid() === true) {
                    ...
                    $.ajax({
                        type: "POST",
                        url: (
                            "{{ route('suiviaffaire.document.add', ['documents_mandant', Crypt::encrypt($bien->id)]) }}"
                            ),
