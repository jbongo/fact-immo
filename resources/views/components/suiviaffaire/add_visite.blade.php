<div class="modal fade" id="visite_add" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
           ...
           <div class="modal-content">
              ...
              <div class="modal-body">
                 <div class="form-validation">
                    <form class="form-appel form-horizontal form-visit" action="{{route('suiviaffaire.visite.add', CryptId($affaire->id))}}" method="post">
                     @csrf
                     <div class="form-group row">
                            <label class="col-sm-4 control-label" for="visitable_type">Type du visiteur<span class="text-danger">*</span></label>
                            <div class="col-lg-3">
                               <select class="js-select2 form-control" id="visitable_type" name="visitable_type" required>
                                 ...
                                 <div class="form-group row" id="vst1">
                                        <label class="col-sm-4 control-label" for="visitable_id_entite">Associer le visiteur (Entité)<span class="text-danger">*</span></label>
                                        <div class="col-lg-4">
                                           <select class="selectpicker col-lg-8" id="visitable_id1" name="visitable_id_entite" data-live-search="true" data-style="btn-warning btn-rounded" required>
                                                 <option></option>
                                     ...
                                     <div class="form-group row" id="vst2">
                                            <label class="col-sm-4 control-label" for="visitable_id_individu">Associer le visiteur (Individu)<span class="text-danger">*</span></label>
                                            <div class="col-lg-4">
                                               <select class="selectpicker col-lg-8" id="visitable_id2" name="visitable_id_individu" data-live-search="true" data-style="btn-info btn-rounded" required>
                                                     <option></option>
                                  ...
                                  @endforeach                                 
                                     ...
                                     <div class="form-group row @if($errors->has('date_visite'))has-error @endif">
                                         ...
                                         <div class="form-group row @if($errors->has('heure_visite'))has-error @endif">
                                                <label class="col-sm-4 control-label" for="heure_visite">Heure de la visite <span class="text-danger">*</span></label>
                                                <div class="col-lg-3">
                                                   <input type="time" id="heure_visite" class="form-control {{$errors->has('heure_visite') ? 'is-invalid' : ''}}" value="{{old('heure_visite')}}" name="heure_visite" required>
                                                </div>
                                             </div>
