<div class="modal fade" id="entite_add" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
       <div class="modal-content">
          <div class="modal-header">
             <h5 class="modal-title" id="exampleModalLabel"><strong>Ajouter une entité</strong></h5>
          </div>
          <div class="modal-body">
             <div class="form-validation">
                <form class="form-appel form-horizontal" action="{{route('contact.entite.store', Crypt::encrypt("123456"))}}" method="post">
                 @csrf
                 ...
                 <div class="form-group row" id="sect1">
                   ...
                   <div class="form-group row @if($errors->has('raison_sociale'))has-error @endif">
                    ...
                    <div class="col-lg-3">
                       <input type="text" id="raison_sociale" class="form-control" value="{{old('raison_sociale')}}" name="raison_sociale" placeholder="Ex: SARL V4F..." required>
                 ...
                 <div class="form-group row @if($errors->has('email'))has-error @endif">
                    ...
                    <div id="sect2">
                            <div class="form-group row @if($errors->has('forme_juridique'))has-error @endif">
                                    ...
                                    <div class="col-lg-3">
                                       <input type="text" id="forme_juridique" class="form-control" value="{{old('forme_juridique')}}" name="forme_juridique" placeholder="Ex: SARL, SAS...">
                 ...
                 <div class="form-group row @if($errors->has('code_postal'))has-error @endif">
                    ...
                    <div class="col-lg-2">
                       <input type="text" id="code_postal" class="form-control" value="{{old('code_postal')}}" name="code_postal" placeholder="Ex: 75001...">
                 ...
                 <div class="form-group row @if($errors->has('ville'))has-error @endif">
                    ...
                    <div class="col-lg-3">
                       <input type="text" id="ville" class="form-control" value="{{old('ville')}}" name="ville" placeholder="Ex: Paris..." >
                       @if ($errors->has('ville'))
                       <br>
                       <div class="alert alert-warning ">
                          <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
                 ...
                 <div class="form-group row @if($errors->has('adresse'))has-error @endif">
                        ...
                        <div class="col-lg-4">
                           <input type="text" id="adresse" class="form-control" value="{{old('adresse')}}" name="adresse" placeholder="Ex: 1 Rue Rivoli...">
                 ...
                 <div class="form-group row @if($errors->has('numero_siret'))has-error @endif">
                    ...
                    <div class="col-lg-2">
                       <input type="text" id="numero_siret" class="form-control {{$errors->has('numero_siret') ? 'is-invalid' : ''}}" value="{{old('numero_siret')}}" name="numero_siret" placeholder="Ex: 729654789...">
                       @if ($errors->has('telephone'))
                       <br>
                       <div class="alert alert-warning ">
                          <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
                 ...
                 <div class="form-group row @if($errors->has('numero_tva'))has-error @endif">
                    ...
                    <div class="col-lg-2">
                       <input type="text" id="numero_tva" class="form-control {{$errors->has('numero_tva') ? 'is-invalid' : ''}}" value="{{old('numero_tva')}}" name="numero_tva" placeholder="Ex: FR98456487...">
