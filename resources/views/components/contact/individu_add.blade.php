<div class="modal fade" id="individu_add" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
           ...
           <div class="modal-content">
              ...
              <div class="modal-body">
                 <div class="form-validation">
                    <form class="form-appel form-horizontal" action="{{route('contact.individu.store')}}" method="post">
                     @csrf
                     ...
                     <div class="form-group row @if($errors->has('date_naissance'))has-error @endif">
                            ...
                            <div class="col-lg-2">
                               <input type="date" id="date_naissance" class="form-control" value="{{old('date_naissance')}}" name="date_naissance">
