                                    ...
                                    <div class="col-lg-4 col-md-4 col-sm-4" style="text-align: right">
                                        @if($mandataire->document($document->id) != null)
                                            ...
                                            @if($mandataire->document($document->id)->valide < 2)
                                                ...
                                                <a href="{{route('document.telecharger', [$mandataire->id, $document->id])}}"data-toggle="tooltip" title="Télécharger {{$document->nom}}"  class="btn btn-danger btn-flat btn-addon "><i class="ti-download"></i>expiré</a> 
