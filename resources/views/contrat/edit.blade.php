                                    ...
                                    <div class="row">
                                        <div class="col-lg-6 col-md-6 col-sm-6">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-4">
                                                    <input type="number" class="form-control" min="1" value="{{$contrat->forfait_administratif}}" id="forfait_administratif" name="forfait_administratif" required>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6">
                                        <div class="form-group row" id="max-starter-parrent">
                                            ...
                                            <div class="col-lg-4 col-md-4 col-sm-4 ">
                                                <input type="number" class="form-control" id="duree_max_starter" name="duree_max_starter" min="1" max="48" value="{{$contrat->duree_max_starter}}" required>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-4 col-md-4 col-sm-4 ">
                                                <input type="number" class="form-control" id="duree_gratuite_starter" name="duree_gratuite_starter" min="0" max="48" value="{{$contrat->duree_gratuite_starter}}" required>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-4 col-md-4 col-sm-4 ">
                                                <input type="number" class="form-control" id="duree_gratuite_expert" name="duree_gratuite_expert" min="0" max="48" value="{{$contrat->duree_gratuite_expert}}" required>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-6-col-md-6 col-sm-6">
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-lg-4 col-md-4 col-sm-4 ">
                                                                    <input class="form-control" type="number" min="0" value="{{$contrat->a_soustraitre}}" max="15" step="0.10" id="a_soustraitre" name="a_soustraitre" required>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
