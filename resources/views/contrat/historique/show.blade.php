                            ...
                            <div class="row">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6">
                                        ...
                                        <div class="form-group row">
                                            <label class="col-lg-6 col-form-label" @if($contrat->duree_pack_info_expert == true) style="background:#f291bf"  @endif for="duree_pack_info_expert">Durée du pack informatique (mois) <span class="text-danger">*</span></label>
                                            <div class="col-lg-4 col-md-4 col-sm-4 ">
