...
<div id="footer">
    ...
    <h1 style="text-align: center;">CONTRAT D’AGENT COMMERCIAL</h1>
        ...
        <p><strong>La société xxx , </strong><strong>xxx</strong> au capital de <strong>xxx</strong> € inscrite au R.C.S. de <strong>xxx</strong>, sous le numéro <strong>xxx</strong>, titulaire de la carte professionnelle « Agent Immobilier » n° <strong>xxx</strong> (transactions sur immeubles et fonds de commerce), délivrée le <strong>xxx</strong> par <strong>xxx</strong> (organisme de garantie : <strong>xxx</strong> – <strong>xxx</strong>), dont le siège est <strong>xxx</strong>, légalement représentée par <strong>xxx</strong>, gérant(e).</p>
        <p>Ci-après dénommé « LE MANDANT » D’une part</p>
        <p> </p>
    <p>Et               Présenté(e) au Réseau par : <strong>xxx xxx</strong></p>
        <p> </p>
        <p> </p>
        <p>NOM : <strong>xxx</strong>                                                 Prénom : <strong>xxx</strong></p>
        <p>Demeurant au : <strong>xxx</strong> </p>
        <p>Code postal et ville : <strong>xxx  xxx</strong> </p>
        <p>Né(e) le:  <strong>xxx</strong>  à : <strong>xxx</strong> </p>
        <p>Pays de nationalité : <strong>xxx</strong> </p>
        <p>Situation familiale : <strong>xxx</strong> </p>
        <p> </p>
        ...
        <p>Elle est exploitée par la société <strong>xxx</strong> et couvre globalement les produits et services suivants :</p>
    ...
    <p>M <strong>xxx xxx</strong> déclare être immatriculé(e) au Registre spécial des agents commerciaux (RSAC) tenu au greffe du tribunal de commerce</p>
        ...
        <p> </p>
        <p>À dater de la signature du présent contrat qui est conclu dans le cadre des dispositions de la loi N°70-9 du 2 janvier 1970 (dite loi "Hoguet") et de son décret d’application, M <strong>xxx xxx</strong> s'engage à représenter commercialement la société <strong>xxx</strong> pour la recherche de vendeurs et d'acquéreurs de biens immobiliers d'habitation ou commerciaux.</p>
        ...
        <p>En cas d'opération menée conjointement avec un autre agent ou une autre agence immobilière, la part de commission revenant au MANDATAIRE devra OBLIGATOIREMENT transiter par le compte bancaire de la société <strong>xxx</strong> (compte n°00020227203 sur la Banque Crédit Mutuel Bagnols sur Cèze).</p>
        ...
        <p>La part de commission qui lui revient conformément au barème établi sera réglée au MANDATAIRE après parfait encaissement par le MANDANT du chèque ou virement correspondant à la commission globale de l'agence. Ce chèque sera obligatoirement établi à l'ordre de la société « <strong>xxx</strong> », titulaire de la carte professionnelle d'agent immobilier.</p>
        ...
        <p>Ainsi, toute intervention sur un dossier en cours, après la cessation, permettant de l’amener à son terme, et ce par une personne du Réseau <strong>xxx</strong> ? rendra caduque le droit de suite.</p>
        ...
        <li>La facturation des outils informatiques et publicitaires se fera selon la tarification établie en annexe 3 ci-jointe. La Société <strong>xxx</strong> s’évertue à obtenir des tarifs préférentiels auprès de ses partenaires néanmoins, ces tarifs peuvent être amenés à être modifiés à tout moment en fonction des négociations avec nos fournisseurs et des changements imposés ceux-ci.</li>
        ...
        <p>4°/ - Le mandataire, qu'il ait ou non un site personnel, devra systématiquement le site internet national du mandant.</p>
        ...
        <p>10°/ - Tous les compromis rédigés par devant notaire, avocat ou par le MANDANT devront mentionner les noms du MANDATAIRE et de la société <strong>xxx</strong> (le MANDANT) et préciser le numéro du mandat, le montant de la commission ainsi que la personne qui devra la régler.</p>
        ...
        <li>Du logiciel informatique spécifique au MANDANT et pourra prises à la vente sur le site Internet du MANDANT.</li>
        ...
        <p> </p>
        <p><em>Je soussigné, déclare par la présente, ma ferme intention de ne recevoir, de manière directe ou indirecte, aucun fonds, effet ou valeur à l'occasion des opérations de « TRANSACTIONS » que je compte effectuer pour le compte de mon mandant, la société <strong>xxx</strong> domiciliée <strong>xxx</strong>.</em></p>
        ...
        <td>
        <p> </p>
        <p>Fait à BAGNOLS SUR CEZE le: <strong></strong></p>
        <p>Gérant(e): <strong></strong></p>
        <p>LE MANDANT</p>
        <p>Lu et approuvé,</p>
        <p>Bon pour mandat</p>
        <p> </p>
    ...
    <td style="width: 80px;">
        ...
        <td>
        <p style="text-align: left;">Date de début d’activité : <strong></strong></p>
        <p style="text-align: left;">M(Mme):<strong>  </strong></p>
