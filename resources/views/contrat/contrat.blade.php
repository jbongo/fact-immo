...
<p>- Publicit&eacute;, gestion des affaires commerciales, administration commerciale, travaux de bureau, diffusion de mat&eacute;riel publicitaire (tract, prospectus, imprim&eacute;s, &eacute;chantillons), conseil en organisation et direction des affaires, comptabilit&eacute;&nbsp;;</p>
...
<p>Le MANDATAIRE &nbsp;d&eacute;clare &ecirc;tre immatricul&eacute;(e) au Registre sp&eacute;cial des agents commerciaux tenu au greffe du tribunal de commerce de &hellip;&hellip;&hellip;&hellip;&hellip;&hellip;&hellip;&hellip;. sous le num&eacute;ro &hellip;&hellip;&hellip;&hellip;&hellip;&hellip;&hellip;&hellip;&hellip;&hellip;*.</p>
...
<p style="page-break-before:always"><strong><u>Article 2 : CONDITIONS D'EXERCICE DU MANDAT</u></strong></p>
...
<li>Parrain actif et non en statut d&rsquo;arr&ecirc;t temporaire <strong>ET</strong></li>
...
<p><strong><u>Article 9.2.1&nbsp;: Obligations du MANDATAIRE li&eacute;es aux commissions directes</u></strong></p>
...
<p>5&deg;/ Le MANDATAIRE assurera &agrave; ses frais exclusifs sa propre prospection t&eacute;l&eacute;phonique et le cas &eacute;ch&eacute;ant son secr&eacute;tariat et s'engage &agrave; respecter les obligations l&eacute;gales et administratives en mati&egrave;re de publicit&eacute; immobili&egrave;re.</p>
...
<p>LE PR&Eacute;SENT CONTRAT A &Eacute;T&Eacute; &Eacute;TABLI EN DEUX EXEMPLAIRES DONT UN EST REMIS AU MANDATAIRE QUI LE RECONNAIT EXPRESS&Eacute;MENT.</p>
<p>&nbsp;</p>
<p><strong><u>ENGAGEMENT SUR L'HONNEUR</u></strong></p>
<p><em>Je soussign&eacute;(e), {{$contrat->user->nom}} {{$contrat->user->prenom}} d&eacute;clare par la pr&eacute;sente, ma ferme intention de ne recevoir, de mani&egrave;re directe ou indirecte, aucun fonds, effet ou valeur &agrave; l'occasion des op&eacute;rations de &laquo;&nbsp;TRANSACTIONS &raquo; que je compte effectuer pour le compte de mon mandant, la soci&eacute;t&eacute; {{$parametre->raison_sociale}} domicili&eacute;e {{$parametre->adresse}} - {{$parametre->code_postal}} {{$parametre->ville}}.</em></p>
...
<p>&nbsp;</p>
<p>&nbsp;</p>
<p>Fait &agrave; Bagnols-sur-C&egrave;ze le&nbsp;:  @if($contrat->date_entree != null) {{$contrat->date_entree->format("d/m/Y")}} @endif &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Date de d&eacute;but d&rsquo;activit&eacute;&nbsp;: @if($contrat->date_deb_activite == null) {{$contrat->date_deb_activite->format("d/m/Y")}} @endif </p>
