...
<p>N&eacute;(e)&nbsp; : &nbsp;  @if($contrat->user->prospect != null) {{$contrat->user->prospect->date_naissance}} @endif &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &agrave;&nbsp;: &nbsp;  @if($contrat->user->prospect != null) {{$contrat->user->prospect->lieu_naissance}} @endif &nbsp;&nbsp;&nbsp;&nbsp;</p>
