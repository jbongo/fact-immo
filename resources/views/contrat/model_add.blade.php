                    ...
                    <hr>
                                       <fieldset class="col-md-12">
                                           ...
                                           <div class="panel panel-warning">
                                               <div class="panel-body">
                                                   <form class="form-valide3" action="{{ route('contrat.update',Crypt::encrypt($modele->id)) }}" method="post" enctype="multipart/form-data">
                                                       {{ csrf_field() }}
                                                       ...
                                                       <div class="row">
                                                           <div class="col-lg-6 col-md-6 col-sm-6">
                                                               ...
                                                               @php
                                                                  $check =  ($modele->est_demarrage_starter == true) ? "checked" : "unchecked";
                                                               @endphp
                                                               <div class="form-group row">
                                                           ...
                                                           <div class="col-lg-6 col-md-6 col-sm-6">
                                                               @php
                                                                   $check_tva =  ($modele->est_soumis_tva == true) ? "checked" : "unchecked";
                                                                   $check_fact_pub =  ($modele->est_soumis_fact_pub == true) ? "checked" : "unchecked";
                                                               @endphp
                                                               <div class="form-group row">
                                                           ...
                                                           <div class="col-lg-6 col-md-6 col-sm-6">
                                                               @php
                                                                   $check_deduis =  ($modele->deduis_jeton == true) ? "checked" : "unchecked";
                                                               @endphp
                                                               <div class="form-group row">
                                           ...
                                           <div class="panel panel-warning">
                                               ...
                                               <div class="row" id="pack_starter">
                                                       ...
                                                       <div class="col-lg-6 col-md-6 col-sm-6">
                                                           ...
                                                           <div class="form-group row">
                                                               ...
                                                               <div class="col-lg-4 col-md-4 col-sm-4 ">
                                                                   <input type="number" class="form-control" value="{{$modele->pourcentage_depart_starter}}" id="pourcentage_depart_starter" name="pourcentage_depart_starter" min="0" max="100" hidden required>
                                                               </div>
                                                           </div>
                                                       </div>
                                                       <div class="col-lg-6 col-md-6 col-sm-6">
                                                   ...
                                                   <div class="row">
                                                       <div class="col-lg-12 col-md-12 col-sm-12">
                                                           @php
                                                               $check1 =  ($modele->a_palier_starter == true) ? "checked" : "unchecked";
                                                           @endphp
                                                           <div class="form-group row">
                                                                   ...
                                                                   <div class="panel-body">
                                                                       <div class="input_fields_wrap_starter">
                                                                           ...
                                                                           <div class="form-inline field1">
                                                                               ...
                                                                               @php
                                                                                   $percent_diff = 95 - $modele->pourcentage_depart_starter;
                                               ...
                                               <div class="row">
                                                   ...
                                                   <div class="row">
                                                       <div class="col-lg-6 col-md-6 col-sm-6">
                                                           ...
                                                           <div class="form-group row">
                                                               ...
                                                               <div class="col-lg-4 col-md-4 col-sm-4 ">
                                                                   <input type="number" class="form-control" id="pourcentage_depart_expert" value="{{$modele->pourcentage_depart_expert}}" name="pourcentage_depart_expert" min="0" max="100" required>
                                                               </div>
                                                           </div>
                                                       </div>
                                                       <div class="col-lg-6 col-md-6 col-sm-6">
                                                   ...
                                                   <div class="row">
                                                       <div class="col-lg-12 col-md-12 col-sm-12">
                                                           @php
                                                               $check2 =  ($modele->a_palier_expert == true) ? "checked" : "unchecked";
                                                           @endphp
                                                           <div class="form-group row">
                                                               ...
                                                               <div class="panel panel-pink m-t-15">
                                                                   ...
                                                                   <div class="panel-body">
                                                                       <div class="input_fields_wrap_expert">
                                                                           ...
                                                                           @php
                                                                               $percent_diff = 95 - $modele->pourcentage_depart_expert;
                                                                       ...
                                                                       <div class="row">
                                                                           <div class="col-lg-6-col-md-6 col-sm-6">
                                                                               <div class="form-group row">
                                                                                   ...
                                                                                   <div class="col-lg-4 col-md-4 col-sm-4 ">
                                                                                       <input class="form-control" type="number" min="0" value="{{$modele->nombre_vente_min}}" id="nombre_vente_min" name="nombre_vente_min" required>
                                                                                   </div>
                                                                               </div>
                                                                               <div class="form-group row">
                                                                                   <label class="col-lg-6 col-md-6 col-sm-6 col-form-label" for="nombre_mini_filleul">Nombre minimum de filleuls parrainés</label>
                                                                                   <div class="col-lg-4 col-md-4 col-sm-4 ">
                                                                                       <input class="form-control" type="number" min="0" value="{{$modele->nombre_mini_filleul}}" id="nombre_mini_filleul" name="nombre_mini_filleul" required>
                                                                                   </div>
                                                                               </div>
                                                                               @php
                                           ...
                                           <div class="col-lg-12">
                                                   ...
                                                   <div class="col-lg-6 col-md-6 col-sm-6">
                                                       <div class="form-group row" id="max-starter-parrent">
                                                           ...
                                                           <div class="col-lg-4 col-md-4 col-sm-4">
                                                               <input type="number" class="form-control" id="seuil_comm" name="seuil_comm" min="0" value="{{$modele->seuil_comm}}" required>
                                                           </div>
                                                       </div>
                                                   </div>
                                                   </div>
                                                       ...
                                                       <div class="col-lg-6 col-md-6 col-sm-6">
                                                           <div class="form-group row">
                                                               <select class="col-lg-4 col-md-4 col-sm-4 form-control" id="pack_pub" name="pack_pub">
                                                                   <option value="{{$modele->packpub->id}}">{{$modele->packpub->nom}}</option>
...
<script>
    // console.log("{{$modele->est_demarrage_starter}}");
    
    if("{{$modele->est_demarrage_starter}}" == 0){
        $('#pack_starter').hide();
    }
    if("{{$modele->a_palier_starter}}" == 0){
            $('#palier_starter').hide();           
    }
