                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive" style="overflow-x: inherit !important;">
                        <table  id="example3" class=" table student-data-table  table-striped table-hover dt-responsive display    "  style="width:100%">
                            ...
                            <tbody>
                            @foreach ($filleuls_actifs as $filleul)
                                @if($filleul->user->contrat->a_demission != true && $filleul->parrain()->contrat->a_demission != true)
                                    ...
                                    <tr>                                    
                                        ...
                                        <td style="color: #e05555;">
                                            <strong> {{ date('d/m/Y ', strtotime('+3 years', strtotime($filleul->created_at->format('Y-m-d'))))     }} </strong> 
                                        </td>
                                        <td>                                            
