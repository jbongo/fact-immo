            ...
            <div class="card-body">
                <div class="form-validation">
                    <form class="form-valide form-horizontal"
                        action="{{ route('fournisseur.update', Crypt::encrypt($fournisseur->id)) }}" method="post">
                        {{ csrf_field() }}
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-8 col-md-8 col-sm-8">
                                        <input type="text"
                                            ...
                                            value="{{ $fournisseur->nom }}" id="nom" name="nom"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-8 col-md-8 col-sm-8">
                                        <input type="url"
                                            ...
                                            value="{{ $fournisseur->site_web }}" id="site_web" name="site_web"
                                ...
                                <div class="form-group row">
                                    <label class="col-lg-4 col-md-4 col-sm-4 control-label" for="telephone1">Contact 1
                                    </label>
                                    <div class="col-lg-8 col-md-8 col-sm-8">
                                        <input type="text"
                                            class="form-control {{ $errors->has('telephone1') ? ' is-invalid' : '' }}"
                                            id="telephone1" value="{{ $fournisseur->telephone1 }}" name="telephone1"
                                            placeholder="">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-8 col-md-8 col-sm-8">
                                        <input type="text"
                                            ...
                                            id="email" value="{{ $fournisseur->email }}" name="email"
                                            placeholder="Email..">
                                        @if ($errors->has('email'))
                                            <br>
                                            <div class="alert alert-warning ">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-8 col-md-8 col-sm-8">
                                        <input type="text"
                                            ...
                                            value="{{ $fournisseur->login }}" id="login" name="login"
                                            placeholder="">
                                        @if ($errors->has('login'))
                                            <br>
                                            <div class="alert alert-warning ">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-8 col-md-8 col-sm-8">
                                        <input type="text"
                                            ...
                                            value="{{ $fournisseur->password }}" id="password" name="password">
                                ...
                                <div class="form-group row">
                                    <label class="col-lg-4 col-md-4 col-sm-4 control-label" for="telephone2">Contact 2
                                    </label>
                                    <div class="col-lg-8 col-md-8 col-sm-8">
                                        <input type="text"
                                            class="form-control {{ $errors->has('telephone2') ? ' is-invalid' : '' }}"
                                            id="telephone2" value="{{ $fournisseur->telephone2 }}" name="telephone2"
                                            placeholder="">
                        ...
                        <div class="form-group row" style="text-align: center; margin-top: 50px;">
                            <div class="col-lg-8 ml-auto">
                                <button class="btn btn-success btn-flat btn-addon btn-lg m-b-10 m-l-5 submit"
                                    id="ajouter"><i class="ti-plus"></i>Modifier</button>
                            </div>
                        </div>
                    </form>
                </div>
