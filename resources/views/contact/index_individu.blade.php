...
<div class="row">
    <div class="col-lg-12 col-sm-12 col-md-12">
       <div class="card alert">
          <a href="#" data-toggle="modal"  data-target="#individu_add" class="btn btn-success btn-rounded btn-addon btn-sm m-b-10 m-l-5"><i class="ti-plus"></i>@lang('Ajouter')</a>
          <div class="card-body">
                <div class="table-responsive" style="overflow-x: inherit !important;">
                        <table  id="individulist" class="table-hover table student-data-table  m-t-20 table-striped"  style="width:100%">
                           <thead>
                              <tr>
                                 <th>@lang('Civilité')</th>
