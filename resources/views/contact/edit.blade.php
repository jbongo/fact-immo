                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6">
                                ...
                                <div class="form-group div_personne_couple">
                                    ...
                                    <div class="col-lg-8 col-md-8 col-sm-8">
                                        <input type="text" class="form-control " value="{{ $infosContact->nom1 }}"
                                ...
                                <div class="form-group div_personne_couple">
                                    <label class="col-lg-4 col-md-4 col-sm-4 control-label" for="prenom1">Prénom <span
                                            class="text-danger">*</span></label>
                                    <div class="col-lg-8 col-md-8 col-sm-8">
                                        <input type="text" class="form-control" value="{{ $infosContact->prenom1 }}"
                                ...
                                <div class="form-group div_personne_couple">
                                    ...
                                    <div class="col-lg-8 col-md-8 col-sm-8">
                                        <input type="text" class="form-control" id="email1"
                                            value="{{ $infosContact->email1 }}" name="email1" required>
                                ...
                                <div class="form-group div_personne_couple">
                                    ...
                                    <div class="col-lg-8 col-md-8 col-sm-8">
                                        <input type="text" class="form-control "
                                            value="{{ $infosContact->telephone_portable1 }}" id="telephone_portable1"
                                ...
                                <div class="form-group div_personne_couple">
                                    ...
                                    <div class="col-lg-8 col-md-8 col-sm-8">
                                        <input type="text" class="form-control "
                                            value="{{ $infosContact->telephone_fixe1 }}" id="telephone_fixe1"
                                ...
                                <div class="form-group div_personne_seule">
                                    <label class="col-lg-4 col-md-4 col-sm-4 control-label" for="nom">Nom <span
                                            class="text-danger">*</span></label>
                                    <div class="col-lg-8 col-md-8 col-sm-8">
                                        <input type="text" class="form-control " value="{{ $infosContact->nom }}"
                                ...
                                <div class="form-group div_personne_seule">
                                    ...
                                    <div class="col-lg-8 col-md-8 col-sm-8">
                                        <input type="text" class="form-control"
                                            value="{{ $infosContact->prenom }}" id="prenom" name="prenom"
                                            required>
                                ...
                                <div class="form-group div_personne_morale">
                                    ...
                                    <div class="col-lg-8 col-md-8 col-sm-8">
                                        <input type="text" class="form-control"
                                            value="{{ $infosContact->raison_sociale }}" id="raison_sociale"
                                ...
                                <div class="form-group div_personne_groupe">
                                    ...
                                    <div class="col-lg-8 col-md-8 col-sm-8">
                                        <input type="text" class="form-control"
                                            value="{{ $infosContact->nom_groupe }}" id="nom_groupe"
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6">
                                ...
                                <div class="form-group div_personne_couple">
                                    ...
                                    <div class="col-lg-8 col-md-8 col-sm-8">
                                        <input type="text" class="form-control "
                                            value="{{ $infosContact->nom2 }}" id="nom2" name="nom2"
                                            required>
                                        @if ($errors->has('nom2'))
                                            <br>
                                            <div class="alert alert-warning ">
                                ...
                                <div class="form-group div_personne_couple">
                                    ...
                                    <div class="col-lg-8 col-md-8 col-sm-8">
                                        <input type="text" class="form-control"
                                            value="{{ $infosContact->prenom2 }}" id="prenom2" name="prenom2"
                                            required>
                                ...
                                <div class="form-group div_personne_couple">
                                    ...
                                    <div class="col-lg-8 col-md-8 col-sm-8">
                                        <input type="text" class="form-control" id="email2"
                                            value="{{ $infosContact->email2 }}" name="email2" required>
                                ...
                                <div class="form-group div_personne_couple">
                                    ...
                                    <div class="col-lg-8 col-md-8 col-sm-8">
                                        <input type="text" class="form-control "
                                            value="{{ $infosContact->telephone_portable2 }}" id="telephone_portable2"
                                ...
                                <div class="form-group div_personne_couple">
                                    ...
                                    <div class="col-lg-8 col-md-8 col-sm-8">
                                        <input type="text" class="form-control "
                                            value="{{ $infosContact->telephone_fixe2 }}" id="telephone_fixe2"
                                ...
                                <div class="form-group div_personne_tout">
                                    ...
                                    <div class="col-lg-8 col-md-8 col-sm-8">
                                        <input type="text" class="form-control" id="email"
                                            value="{{ $infosContact->email }}" name="email" required>
                                        @if ($errors->has('email'))
                                            <br>
                                            <div class="alert alert-warning ">
                                ...
                                <div class="form-group div_personne_tout">
                                    ...
                                    <div class="col-lg-8 col-md-8 col-sm-8">
                                        <input type="text" class="form-control "
                                            value="{{ $infosContact->telephone_portable }}" id="telephone_portable"
                                ...
                                <div class="form-group div_personne_tout">
                                    ...
                                    <div class="col-lg-8 col-md-8 col-sm-8">
                                        <input type="text" class="form-control "
                                            value="{{ $infosContact->telephone_fixe }}" id="telephone_fixe"
                                            name="telephone_fixe">
                                ...
                                <div class="form-group div_personne_morale ">
                                    ...
                                    <div class="col-lg-8 col-md-8 col-sm-8">
                                        <input type="text" id="numero_siret" class="form-control "
                                            value="{{ $infosContact->numero_siret }}" name="numero_siret">
                                ...
                                <div class="form-group div_personne_morale ">
                                    ...
                                    <div class="col-lg-8 col-md-8 col-sm-8">
                                        <input type="text" id="numero_tva" class="form-control "
                                            value="{{ $infosContact->numero_tva }}" name="numero_tva">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-8 col-md-8 col-sm-8">
                                        <input type="text" class="form-control "
                                            value="{{ $infosContact->adresse }}" id="adresse" name="adresse">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-8 col-md-8 col-sm-8">
                                        <input type="text" class="form-control"
                                            value="{{ $infosContact->code_postal }}" id="code_postal"
                                            name="code_postal">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-8 col-md-8 col-sm-8">
                                        <input type="text" class="form-control"
                                            value="{{ $infosContact->ville }}" id="ville" name="ville">
                                        @if ($errors->has('ville'))
                                            <br>
                                            <div class="alert alert-warning ">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-8 col-md-8 col-sm-8">
                                        <input type="text"
                                            ...
                                            value="{{ $infosContact->pays }}" id="pays" name="pays"
