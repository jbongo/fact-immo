...
<div class="row">
    <div class="col-lg-12 col-md-12 col-sm-12">
        ...
        <div class="card">
            <div class="col-lg-12">
                <a href="{{ route('mandataire.index') }}" class="btn btn-warning btn-flat btn-addon m-b-10 m-l-5"><i
                        class="ti-angle-double-left"></i>@lang('Liste des mandataires')</a>
            </div>
            <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6">
                                ...
                                <div class="form-group row">
                                    <label class="col-lg-4 col-md-4 col-sm-4 control-label" for="statut">Statut <span
                                            class="text-danger">*</span></label>
                                    <div class="col-lg-8 col-md-8 col-sm-8">
                                        <select
                                            class="js-select2 form-control {{ $errors->has('statut') ? 'is-invalid' : '' }}"
                                            id="statut" name="statut" style="width: 100%;"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-8 col-md-8 col-sm-8">
                                        <select
                                            class="js-select2 form-control {{ $errors->has('civilite') ? 'is-invalid' : '' }}"
                                            id="civilite" name="civilite" style="width: 100%;"
                                            data-placeholder="Choose one.." required>
                                ...
                                <div class="form-group row">
                                    <label class="col-lg-4 col-md-4 col-sm-4 control-label" for="val-email">Email
                                        pro<span class="text-danger">*</span></label>
                                    <div class="col-lg-8 col-md-8 col-sm-8">
                                        <input type="text"
                                            class="form-control {{ $errors->has('email') ? ' is-invalid' : '' }}"
                                            id="val-email" value="{{ old('email') }}" name="email"
                                ...
                                <div class="form-group row">
                                    <label class="col-lg-4 col-md-4 col-sm-4 control-label" for="val-email_perso">Email
                                        perso<span class="text-danger">*</span></label>
                                    <div class="col-lg-8 col-md-8 col-sm-8">
                                        <input type="text"
                                            class="form-control {{ $errors->has('email_perso') ? ' is-invalid' : '' }}"
                                            id="val-email_perso" value="{{ old('email_perso') }}" name="email_perso"
                                            placeholder="Email.." required>
                                ...
                                <div class="form-group row">
                                    <label class="col-lg-4 col-md-4 col-sm-4 control-label" for="siret">Numéro SIRET
                                    </label>
                                    <div class="col-lg-8 col-md-8 col-sm-8">
                                        <input type="text"
                                            class="form-control {{ $errors->has('siret') ? ' is-invalid' : '' }}"
                                            value="{{ old('siret') }}" id="siret" name="siret"
                                            placeholder="Ex: 2561452136582">
                                        @if ($errors->has('siret'))
                                            <br>
                                            <div class="alert alert-warning ">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-8 col-md-8 col-sm-8">
                                        <input type="text"
                                            class="form-control {{ $errors->has('numero_tva') ? ' is-invalid' : '' }}"
                                            value="{{ old('numero_tva') }}" id="numero_tva" name="numero_tva">
                                ...
                                <div class="form-group row">
                                    <label class="col-lg-4 col-md-4 col-sm-4 control-label" for="numero_rsac">Numéro
                                        RSAC </label>
                                    <div class="col-lg-8 col-md-8 col-sm-8">
                                        <input type="text"
                                            class="form-control {{ $errors->has('numero_rsac') ? ' is-invalid' : '' }}"
                                            value="{{ old('numero_rsac') }}" id="numero_rsac" name="numero_rsac"
                                            placeholder="">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6">
                                ...
                                <div class="form-group row">
                                    <label class="col-lg-4 col-md-4 col-sm-4 control-label" value=""
                                        for="compl_adresse">Complément d'adresse</label>
                                    <div class="col-lg-8 col-md-8 col-sm-8">
                                        <input type="text" id="compl_adresse"
                                            class="form-control {{ $errors->has('compl_adresse') ? ' is-invalid' : '' }}"
                                            value="{{ old('compl_adresse') }}" name="compl_adresse"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-8 col-md-8 col-sm-8">
                                        <input type="text"
                                            ...
                                            value="{{ old('code_postal') }}" id="code_postal" name="code_postal"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-8 col-md-8 col-sm-8">
                                        <input type="text"
                                            ...
                                            value="{{ old('pays') }}" id="pays" name="pays"
                                ...
                                <div class="form-group row">
                                    <label class="col-lg-4 col-md-4 col-sm-4 control-label" for="telephone1">Téléphone
                                        pro </label>
                                    <div class="col-lg-8 col-md-8 col-sm-8">
                                        <input type="text"
                                            class="form-control {{ $errors->has('telephone1') ? ' is-invalid' : '' }}"
                                            value="{{ old('telephone1') }}" id="telephone1" name="telephone1"
                                ...
                                <div class="form-group row">
                                    <label class="col-lg-4 col-md-4 col-sm-4 control-label" for="telephone2">Téléphone
                                        perso </label>
                                    <div class="col-lg-8 col-md-8 col-sm-8">
                                        <input type="text"
                                            class="form-control {{ $errors->has('telephone2') ? ' is-invalid' : '' }}"
                                            value="{{ old('telephone2') }}" id="telephone2" name="telephone2"
                                            placeholder="Ex: 0600000000..">
                                ...
                                <div class="form-group row">
                                    <span class="text-danger"> <strong> (4 premières lettres du NOM et 1ere lettre du
                                            prénom ) </strong></span>

                                    <label class="col-lg-4 col-md-4 col-sm-4 control-label" for="code_client">WINFIC
                                        Code client <span class="text-danger">*</span> </label>
                                    <div class="col-lg-8 col-md-8 col-sm-8">
                                        <input type="text"
                                            class="form-control {{ $errors->has('code_client') ? ' is-invalid' : '' }}"
                                            value="{{ old('code_client') }}" id="code_client" name="code_client"
