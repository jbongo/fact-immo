                            ...
                            <table  id="example" class=" table student-data-table  m-t-20 "  style="width:100%">
                                ...
                                @foreach ($mandataires as $mandataire)
                                    <tr>
                                        ...
                                        <td>
                                            <span><a href="{{route('mandataire.show',$mandataire->id)}}" data-toggle="tooltip" title="@lang('Détails de ') {{ $mandataire->nom }}"><i class="large material-icons color-info">visibility</i></a> </span>
                                            <span><a href="{{route('mandataire.edit',$mandataire->id)}}" data-toggle="tooltip" title="@lang('Modifier ') {{ $mandataire->nom }}"><i class="large material-icons color-warning">edit</i></a></span>
