...
<div class="row">
	<div class="col-lg-12">
		...
		<div class="card">
			<div class="col-lg-10">
                    <a class="btn btn-danger btn-flat btn-addon btn-sm m-b-10 m-l-5 submit" href="{{route('facture.generer_facture_stylimmo', Crypt::encrypt($compromis->id) )}}" ><i class="ti-file"></i>Générer Facture stylimmo</a>
            </div>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-4 col-md-4 col-sm-4">
                                            <div class="form-group row" id="parrain-id">
                                                ...
                                                <div class="col-lg-8">
                                                    <input type="text" class="form-control" id="civilite_vendeur" style='color=red'  value="{{ $compromis->civilite_vendeur}}" name="civilite_vendeur" required>  
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-lg-4 col-md-4 col-sm-4">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-4 col-md-4 col-sm-4">
                                            <div class="form-group row" id="parrain-id">
                                                ...
                                                <div class="col-lg-8">
                                                        <input type="text" class="form-control" id="civilite_acquereur" style='color=red'  value="{{ $compromis->civilite_acquereur}}" name="civilite_acquereur" required>  
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-lg-4 col-md-4 col-sm-4">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-3 col-md-3 col-sm-3">
                                                <div class="form-group row" id="parrain-id">
                                                    ...
                                                    <div class="col-lg-8">
                                                        <input type="text" class="form-control" id="nom_agent" name="partage" value="{{ $compromis->est_partage == 0 ? "Non":"Oui"}}" >                                                                                                            
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-3 col-md-3 col-sm-3">
                                                <div class="form-group row" id="parrain-id">
                                                    ...
                                                    <div class="col-lg-8">
                                                        <input type="number" class="form-control" id="charge" name="charge" value="{{ $compromis->charge}}" required>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-lg-3 col-md-3 col-sm-3">
