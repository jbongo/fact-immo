...
<div class="row">
    <div class="col-lg-12 col-md-12 col-sm-12">
        ...
        <div class="card">
            <div class="col-lg-12">
                <a href="{{ route('outil_info.index') }}" class="btn btn-warning btn-flat btn-addon m-b-10 m-l-5"><i
                        class="ti-angle-double-left"></i>@lang('Outils Informatique')</a>
            </div>
            <div class="card-body">
                    ...
                    <form class="form-valide form-horizontal" action="{{ route('fiche_info.store') }}" method="post">
                        ...
                        @foreach ($outils as $outil)
                            ...
                            <div class="row">
                                <br>
                                <br>
                                <input type="hidden" value="{{ $outil->id }}" id="id_{{ $outil->id }}"
                                    name="id_{{ $outil->id }}">

                                <div class="col-lg-6 col-md-6 col-sm-6">
                                    <div class="form-group row">
                                        <label class="col-lg-4 col-md-4 col-sm-4 control-label"
                                            for="nom_{{ $outil->id }}">Nom <span
                                                class="text-danger">*</span></label>
                                        <div class="col-lg-8 col-md-8 col-sm-8">
                                            <input type="text" class="form-control " value="{{ $outil->nom }}"
                                                id="nom_{{ $outil->id }}" name="nom_{{ $outil->id }}"
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-6">
                                    <div class="form-group row">
                                        <label class="col-lg-4 col-md-4 col-sm-4 control-label"
                                            for="site_web_{{ $outil->id }}">Site web <span
                                                class="text-danger">*</span></label>
                                        <div class="col-lg-8 col-md-8 col-sm-8">
                                            <input type="url"
                                                class="form-control {{ $errors->has('site_web') ? 'is-invalid' : '' }}"
                                                value="{{ $outil->site_web }}" id="site_web_{{ $outil->id }}"
                                                name="site_web_{{ $outil->id }}">
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-6">
                                    <div class="form-group row">
                                        <label class="col-lg-4 col-md-4 col-sm-4 control-label"
                                            for="identifiant_{{ $outil->id }}">Identifiant </label>
                                        <div class="col-lg-8 col-md-8 col-sm-8">
                                            <input type="text"
                                                class="form-control {{ $errors->has('identifiant') ? 'is-invalid' : '' }}"
                                                value="{{ $outil->identifiant ? $outil->identifiant : $mandataire->email }}"
                                                id="identifiant_{{ $outil->id }}"
                                                name="identifiant_{{ $outil->id }}">
                                ...
                                @php
                                    ...
                                    $password = $outil->password ? $outil->password : $mandataire->getPassword();
                                    if ($outil->nom == 'TAK TIK IMMO') {
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-6">
                                    <div class="form-group row">
                                        <label class="col-lg-4 col-md-4 col-sm-4 control-label"
                                            for="password_{{ $outil->id }}">Mot de passe </label>
                                        <div class="col-lg-8 col-md-8 col-sm-8">
                                            <input type="text"
                                                class="form-control {{ $errors->has('password') ? 'is-invalid' : '' }}"
                                                value="{{ $password }}" id="nom_{{ $outil->id }}"
                                                name="password_{{ $outil->id }}">
                   ...
                   <div class="col-lg-6 col-md-6 col-sm-6">
                    ...
                    @endforeach --}}
                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12" style="margin-top:100px; float:left;">
                                    ...
                                    <div class="form-group row">
                                        <label class="col-lg-2 col-md-2 col-sm-2  control-label" value=""
                                            for="autre_champ_{{ $outil->id }}">Autre champ</label>
                                        <div class="col-lg-6 col-md-6 col-sm-6 ">
                        ...
                        <div class="form-group row">
                            <div class="col-lg-8 ml-auto">
                                <button class="btn btn-success btn-flat btn-addon btn-lg m-b-10 m-l-5 submit"
                                    id="ajouter" style="text-align: center; margin-top: 50px; "><i
                                        class="ti-plus"></i>Enregistrer</button>
                            </div>
                        </div>
                    </form>
                </div>
...
<script src="https://cdn.tiny.cloud/1/t0hcdz1jd4wxffu3295e02d08y41e807gaxas0gefdz7kcb4/tinymce/5/tinymce.min.js"
