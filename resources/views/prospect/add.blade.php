...
<div class="row">
    <div class="col-lg-12 col-md-12 col-sm-12">
        ...
        <div class="card">
            <div class="col-lg-12">
                <a href="{{ route('prospect.index') }}" class="btn btn-warning btn-flat btn-addon m-b-10 m-l-5"><i
                        class="ti-angle-double-left"></i>@lang('Liste des prospects')</a>
            </div>
            <div class="card-body">
                    ...
                    <form class="form-valide form-horizontal" action="{{ route('prospect.add') }}" method="post">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-8 col-md-8 col-sm-8">
                                        <input type="text"
                                            ...
                                            id="val-email_perso" value="{{ old('email') }}" name="email"
                                ...
                                <div class="form-group row">
                                    <label class="col-lg-4 col-md-4 col-sm-4 control-label" for="a_parrain">Le prospect
                                        a t'il un parrain ?</label>
                                    <div class="col-lg-6">
                                        <input type="checkbox" data-toggle="toggle" id="a_parrain" name="a_parrain"
                                            data-off="Non" data-on="Oui" data-onstyle="success" data-offstyle="danger">
                                    </div>
                                </div>
                                <div id="parrain_div">
                                    <div class="form-group row">
                                        <label class="col-lg-4 col-md-4 col-sm-4 control-label" for="parrain_id">Choisir
                                            le parrain</label>
                                        <div class="col-lg-8">
                                            <select class="selectpicker col-lg-6" id="parrain_id" name="parrain_id"
                                                data-live-search="true" data-style="btn-warning btn-rounded">
                                                @foreach ($parrains as $parrain)
                                                    <option value="{{ $parrain->id }}"
                                                        data-tokens="{{ $parrain->nom }} {{ $parrain->prenom }}">
                                                        {{ $parrain->nom }} {{ $parrain->prenom }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                ...
                                <div id="source_div">
                                    <div class="form-group row">
                                        <label class="col-lg-4 col-md-4 col-sm-4 control-label" for="source_id">Choisir
                                            la source du prospect</label>
                                        <div class="col-lg-8">
                                ...
                                <div class="form-group row">
                                    <label class="col-lg-4 col-md-4 col-sm-4 control-label"
                                        for="commentaire_perso">Commentaire admin</label>
                                    <div class="col-lg-8 col-md-8 col-sm-8">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-8 col-md-8 col-sm-8">
                                        <input type="text"
                                            ...
                                            value="{{ old('code_postal') }}" id="code_postal" required
                                            name="code_postal" placeholder="Ex: 75001..">
                                ...
                                <div class="form-group row">
                                    <label class="col-lg-4 col-md-4 col-sm-4 control-label"
                                        for="telephone_portable">Téléphone portable <span
                                            class="text-danger">*</span></label>
                                    <div class="col-lg-8 col-md-8 col-sm-8">
                                        <input type="text"
                                            class="form-control {{ $errors->has('telephone_portable') ? ' is-invalid' : '' }}"
                                            value="{{ old('telephone_portable') }}" id="telephone_portable" required
                                            name="telephone_portable" placeholder="Ex: 0600000000..">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-8 col-md-8 col-sm-8">
                                        <input type="text"
                                            class="form-control {{ $errors->has('telephone_fixe') ? ' is-invalid' : '' }}"
                                            value="{{ old('telephone_fixe') }}" id="telephone_fixe"
                                            name="telephone_fixe" placeholder="Ex: 0600000000..">
                                ...
                                <div class="form-group row">
                                    <label class="col-lg-4 col-md-4 col-sm-4 control-label"
                                        for="commentaire_pro">Commentaire prospect</label>
                                    <div class="col-lg-8 col-md-8 col-sm-8">
