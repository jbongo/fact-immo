                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td width="" >
                                        ...
                                        <a class="color-info" title="Télécharger la facture stylimmo"  href="{{route('facture.telecharger_pdf_facture_stylimmo', Crypt::encrypt($compromi_sous_offre->getFactureStylimmo()->id))}}"  class="  m-b-10 m-l-5 " id="ajouter">{{$compromi_sous_offre->getFactureStylimmo()->numero}} <i class="ti-download"></i> </a>
                                        @else 
                                   ...
                                   @if($compromi_sous_offre->date_mandat != null) {{$compromi_sous_offre->date_mandat->format('d/m/Y')}} @endif  
                                    ...
                                    <span><a class="btn btn-default demander_facture" href="{{route('facture.demander_facture',Crypt::encrypt($compromi_sous_offre->id))}}" data-toggle="tooltip" date_vente="{{$compromi_sous_offre->date_vente->format('d/m/Y')}}" date-vente="{{$compromi_sous_offre->date_vente->format('m/d/Y')}}" title="@lang('')">demander facture styl</a> </span>
                                            ...
                                            @else 
                                            <a href="{{route('facture.telecharger_pdf_facture_stylimmo', Crypt::encrypt($compromi_sous_offre->getFactureStylimmo()->id))}}"  class="btn btn-warning btn-flat btn-addon  m-b-10 m-l-5 " id="ajouter"><i class="ti-download"></i>Télécharger</a>
                                            @endif
                                        @endif
                                    </td>                                
                                    ...
                                    <td width="15%">
                                            ...
                                            @if($page_filleul == null)
                                                @if ($compromi_sous_offre->cloture_affaire == 0 && $compromi_sous_offre->demande_facture == 2 && $compromi_sous_offre->agent_id != Auth()->user()->id)
                                                    <a class="cloturer" href="{{route('compromis.cloturer',Crypt::encrypt($compromi_sous_offre->id))}}" data-toggle="tooltip" data-mandat="{{$compromi_sous_offre->numero_mandat}}" title="@lang('Réitérer l\'affaire  ')"><img src="{{asset('images/logo-notaire.png')}}" width="25px" height="30px" alt=""></a> 
