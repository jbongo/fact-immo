                                            ...
                                            <td width="">
                                                @if ($compromi_enc->getFactureStylimmo() != null)
                                                    <a class="color-info" title="Télécharger la facture stylimmo"
                                                        href="{{ route('facture.telecharger_pdf_facture_stylimmo', Crypt::encrypt($compromi_enc->getFactureStylimmo()->id)) }}"
                                                        class="  m-b-10 m-l-5 "
                                   ...
                                   @if ($compromi_enc->date_mandat != null) {{$compromi_enc->date_mandat->format('d/m/Y')}} @endif  
                                            ...
                                            <td style="{{ $grise }}">
                                                @if ($compromi_enc->je_porte_affaire == 1 && $compromi_enc->agent_id != Auth()->user()->id)
                                                    ...
                                                    @else
                                                        <a href="{{ route('facture.telecharger_pdf_facture_stylimmo', Crypt::encrypt($compromi_enc->getFactureStylimmo()->id)) }}"
