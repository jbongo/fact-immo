                                                        ...
                                                        <div class="row">
                                                            <div class="col-lg-5 col-md-5 col-sm-5">
                                                                <div class="form-group" id="div_pourcentage_agent">
                                                                    <label class="col-lg-8 col-md-8 col-sm-8 col-form-label" for="pourcentage_agent"> @if(Auth()->user()->id == $compromis->user->id) Mon % de partage @else % de {{$compromis->user->prenom}} {{$compromis->user->nom}}     @endif <span class="text-danger">*</span></label>
                                                                    <div class="col-lg-6 col-md-6 col-sm-6 ">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-4 col-md-4 col-sm-4">
                                                <div class="form-group row" id="parrain-id">
                                                    <label class="" for="parr-id">Net Vendeur</label>  <span class="text-danger">*</span></label>
                                                        ...
                                                        <input type="number" min="0" step="0.01" class="form-control" id="net_vendeur" name="net_vendeur" value="{{ $compromis->net_vendeur}}" required>                                                    
                                            ...
                                            <div class="col-lg-4 col-md-4 col-sm-4">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" min="0" min="0" step="0.01" type="number" value="{{ $compromis->frais_agence}}" id="frais_agence" name="frais_agence" required>
                                                </div>
                                            </div>
                                            <div class="col-lg-4 col-md-4 col-sm-4">
                                                <div class="form-group row" id="parrain-id">
