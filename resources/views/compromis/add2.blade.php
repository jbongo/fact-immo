...
@section('content')
@section('page_title')
    Ajoutez le compromis du mandat {{ $bien->mandat->numero }}
@endsection
<div class="row">
    <div class="col-lg-12">
        @if (session('ok'))
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form class="form-valide3" enctype="multipart/form-data"
                    action="{{ route('compromis.add2', Crypt::encrypt($bien->id)) }}" method="post">
                    {{ csrf_field() }}
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-4 col-md-4 col-sm-4">
                                            <div class="form-group row">
                                                <label class="col-lg-8 col-md-8 col-sm-8 col-form-label"
                                                    for="partage">Partage avec Agence/Agent ? <span
                                                        class="text-danger">*</span></label>
                                                <div class="col-lg-6 col-md-6 col-sm-6 ">
                                                    <select class="js-select2 form-control" id="partage"
                                                        name="partage" required>
                                        ...
                                        <div class="col-lg-4 col-md-4 col-sm-4">
                                            <div class="form-group div_agent_hors_reseau">
                                                <label class="col-lg-8 col-md-8 col-sm-8 col-form-label"
                                                    for="nom_agent">Nom de l'agence <span
                                                        class="text-danger">*</span></label>
                                                <div class="col-lg-6 col-md-6 col-sm-6">

                                                    <input class="form-control" type="text"
                                                        value="{{ old('nom_agent') ? old('nom_agent') : ' ' }}"
                                    ...
                                    <div class="row">
                                        <div class="col-lg-4 col-md-4 col-sm-4">
                                            <div class="form-group" id="div_pourcentage_agent">
                                                <label class="col-lg-8 col-md-8 col-sm-8 col-form-label"
                                                    for="pourcentage_agent">Mon % de partage <span
                                                        class="text-danger">*</span></label>
                                                <div class="col-lg-6 col-md-6 col-sm-6 ">
                                                    <input class="form-control" type="number" min="0"
                                                        max="100"
                                                        value="{{ old('pourcentage_agent') ? old('pourcentage_agent') : 0 }}"
                                                        id="pourcentage_agent" name="pourcentage_agent" required>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-4 col-md-4 col-sm-4" id="div_je_porte_affaire">
                                            <div class="form-group row">
                                                <label class="col-lg-7 col-md-7 col-sm-7" for="je_porte_affaire">Je
                                                    porte l'affaire</label>
                                                <div class="col-lg-6 col-md-6 col-sm-6">
                                                    <input type="checkbox" checked data-toggle="toggle"
                                                        id="je_porte_affaire" name="je_porte_affaire" data-off="Non"
                                                        data-on="Oui" data-onstyle="success" data-offstyle="danger">
                                                </div>
                                            </div>
                                            <div class="alert alert-success" style="color:red;"
                                                id="div_partage_non_porte_alert">
                                                <a href="#" class="close" data-dismiss="alert"
                                                    aria-label="close">&times;</a>
                                                <strong>Info !</strong> L'affaire sera renseignée par <label
                                                    id="label_partage_name"> </label>.
                                            </div>
                                            <div class="alert alert-success" style="color:red;"
                                                id="div_partage_porte_alert">
                                                <a href="#" class="close" data-dismiss="alert"
                                                    aria-label="close">&times;</a>
                                                <strong>Info !</strong> Si vous portez l'affaire, c'est vous qui ferez
                                                la demande de facture STYL'IMMO .
                                            </div>
                                        </div>
                        ...
                        <div class="row">
                                ...
                                <div class="form-group ">
                                    ...
                                    <div class=" col-lg-12 col-md-12 col-sm-12 ">
                                        <textarea class="form-control" maxlength="180" name="description_bien" id="description_bien" cols="50"
                                            rows="5" required>{{ old('description_bien') }}</textarea>
                            ...
                            <div class="col-lg-3 col-md-3 col-sm-3">
                                <div class="form-group ">
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12 ">
                                        <input class="form-control" type="text"
                                            value="{{ old('code_postal_bien') }}" id="code_postal_bien"
                            ...
                            <div class="col-lg-3 col-md-3 col-sm-3">
                                <div class="form-group ">
                                    <label class="col-lg-7 col-md-7 col-sm-7 " for="ville_bien">Ville du bien <span
                                            class="text-danger">*</span></label>
                                    <div class="col-lg-12 col-md-12 col-sm-12 ">
                                        <input class="form-control" type="text" value="{{ old('ville_bien') }}"
                                            id="ville_bien" name="ville_bien" required>
                                    </div>
                                </div>
                            </div>
                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-4 col-md-4 col-sm-4">
                                                <div class="form-group row">
                                                    ...
                                                    <label class="col-lg-12 col-md-12 col-sm-12 col-form-label"
                                                        for="civilite_vendeur">Civilité / Forme Juridique<span
                                                            class="text-danger">*</span></label>
                                                    <div class="col-lg-8 col-md-8 col-sm-8 ">
                                                        <select class="js-select2 form-control" id="civilite_vendeur"
                                            ...
                                            <div class="col-lg-8 col-md-8 col-sm-8">
                                                <div class="form-group" id="div_nom_vendeur">
                                                    ...
                                                    <input class="form-control" type="text"
                                                        value="{{ old('nom_vendeur') ? old('nom_vendeur') : ' ' }}"
                                                        id="nom_vendeur" name="nom_vendeur" required>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-3 col-md-3 col-sm-3">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" type="text"
                                                        value="{{ old('adresse1_vendeur') }}" id="adresse1_vendeur"
                                            ...
                                            <div class="col-lg-3 col-md-3 col-sm-3">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" type="text"
                                                        value="{{ old('adresse2_vendeur') }}" id="adresse2_vendeur"
                                            ...
                                            <div class="col-lg-3 col-md-3 col-sm-3">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" type="text"
                                                        value="{{ old('code_postal_vendeur') }}"
                                                        id="code_postal_vendeur" name="code_postal_vendeur">
                                                </div>
                                            </div>
                                            <div class="col-lg-3 col-md-3 col-sm-3">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" type="text"
                                                        value="{{ old('ville_vendeur') }}" id="ville_vendeur"
                                                        name="ville_vendeur">
                                                </div>
                                            </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-4 col-md-4 col-sm-4">
                                                <div class="form-group row">
                                                    ...
                                                    <label class="col-lg-12 col-md-12 col-sm-12 col-form-label"
                                                        for="civilite_acquereur">Civilité / Forme Juridique <span
                                                            class="text-danger">*</span></label>
                                                    <div class="col-lg-8 col-md-8 col-sm-8 ">
                                                        <select class="js-select2 form-control"
                                                            id="civilite_acquereur" name="civilite_acquereur">
                                                            <option value="M.">M.</option>
                                                            <option value="Mme">Mme</option>
                                                            <option value="MM.">MM.</option>
                                                            <option value="Mmes">Mmes</option>
                                            ...
                                            <div class="col-lg-8 col-md-8 col-sm-8">
                                                <div class="form-group" id="div_nom_acquereur">
                                                    ...
                                                    <input class="form-control" type="text"
                                                        value="{{ old('nom_acquereur') ? old('nom_acquereur') : ' ' }}"
                                                        id="nom_acquereur" name="nom_acquereur" required>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-3 col-md-3 col-sm-3">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" type="text"
                                                        value="{{ old('adresse1_acquereur') }}"
                                                        id="adresse1_acquereur" name="adresse1_acquereur">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-3 col-md-3 col-sm-3">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" type="text"
                                                        value="{{ old('adresse2_acquereur') }}"
                                                        id="adresse2_acquereur" name="adresse2_acquereur">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-3 col-md-3 col-sm-3">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" type="text"
                                                        value="{{ old('code_postal_acquereur') }}"
                                                        id="code_postal_acquereur" name="code_postal_acquereur">
                                                </div>
                                            </div>
                                            <div class="col-lg-3 col-md-3 col-sm-3">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" type="text"
                                                        value="{{ old('ville_acquereur') }}" id="ville_acquereur"
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-3 col-md-3 col-sm-3">
                                                <div class="form-group row">
                                                    <label class="col-lg-8 col-md-8 col-sm-8 col-form-label"
                                                        for="charge">Charge vendeur/Acquereur <span
                                                            class="text-danger">*</span></label>
                                                    <div class="col-lg-6 col-md-6 col-sm-6 ">
                                                        <select class="js-select2 form-control" id="charge"
                                                            name="charge" required>
                                                            @if ($bien->honoraire_acquereur == 'Oui')
                                            ...
                                            <div class="col-lg-4 col-md-4 col-sm-4" id="div_net_vendeur">
                                                <div class="form-group">
                                                    <label for="net_vendeur">Net Vendeur TTC<span
                                                            class="text-danger">*</span></label>
                                                    <input class="form-control" min="0" step="0.01"
                                                        value="{{ $bien->prix_prive }}" type="number"
                                                        value="{{ old('net_vendeur') }}" id="net_vendeur"
                                                        name="net_vendeur" required>
                                                </div>
                                            </div>
                                            <div class="col-lg-4 col-md-4 col-sm-4">
                                                <div class="form-group">
                                                    <label for="frais_agence">Frais d'agence TTC <span
                                                            class="text-danger">*</span> </label>
                                                    <input class="form-control" min="0" step="0.01"
                                                        value="{{ $bien->frais_agence }}" type="number"
                                                        value="{{ old('frais_agence') }}" id="frais_agence"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-4 col-md-4 col-sm-4">
                                                <div class="form-group">
                                                    <label for="scp_notaire">SCP Notaire <span
                                                            class="text-danger">*</span> </label>
                                                    <input class="form-control" type="texte"
                                                        value="{{ old('scp_notaire') }}" id="scp_notaire"
                                                        name="scp_notaire" required>
                                                </div>
                                            </div>

                                            <div class="col-lg-4 col-md-4 col-sm-4">
                                                <div class="form-group">
                                                    <label for="date_vente">Date provisoire de la Vente / Date entrée
                                                        logement <span class="text-danger">*</span> </label>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-6">
                                                <div class="form-group ">
                                                    <label class=" col-lg-7 col-md-7 col-sm-7 "
                                                        for="observations">Observations </span></label>
                                                    <div class=" col-lg-12 col-md-12 col-sm-12 ">
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-6">
                                                <div class="form-group">
                                                    <label for="pdf_compromis">Fichier pdf du compromis / contrat de
                                                        bail </label>
                                                    <input class="form-control" accept=".pdf" type="file"
                                                        value="" id="pdf_compromis" name="pdf_compromis">
                                                    <div id="" class="alert alert-info"
                                                        style="color: #1e003c;" role="alert"> Pour que l'affaire
                                                        passe sous compromis, il rajouter le fichier. Ajouter le fichier
                                                        10 jours max après la signature </div>
                                                </div>
                                            </div>
                    ...
                    <div class="form-validation">
                        <div class="form-group row" style="text-align: center; margin-top: 50px;">
                            <div class="col-lg-8 ml-auto">
                                <button class="btn btn-danger btn-flat btn-addon btn-lg m-b-10 m-l-5 "
                                    id="enregistrer"><i class="ti-file"></i>Enregistrer</button>
                            </div>
                        </div>
                    </div>
...
<script>
    ...
    var numero_mandat_porte_pas = "{{ $bien->mandat->numero }}"
    ...
    $('#je_porte_affaire').change(function() {
        ...
        <div id="sous_div_mandat_partage">                        
            ...
            <div class="form-group">
                ...
                <div class="col-lg-6 col-md-6 col-sm-6 ">
                    <input class="form-control" type="number" min="10000" max="99999" value="${numero_mandat_porte_pas}" value="{{ old('numero_mandat_porte_pas') }}" id="numero_mandat_porte_pas" name="numero_mandat_porte_pas" required>
                </div>
            </div>
