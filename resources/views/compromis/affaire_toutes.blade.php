                            ...
                            <div class="panel panel-info ">
                                <div class="panel-body">
                                    ...
                                    <div class="table-responsive">
                                        <table id="example"
                                            class=" table student-data-table  table-striped table-hover  display  nowrap  "
                                            style="width:100%">
                                                   ...
                                                   @if ($compromi->date_mandat != null) {{$compromi->date_mandat->format('d/m/Y')}} @endif  
                                                                    ...
                                                                    @if ($compromi->getPartage() != null)
                                                                        @if ($compromi->getPartage()->id == Auth()->user()->id)
                                                                            <strong> <a>{{ $compromi->user->nom }}
                                                                                    {{ $compromi->user->prenom }} <span
                                                                                        class="color-danger">
                                                                                        ({{ $compromi->pourcentage_agent }}
                                                                                        %) </span></a> </strong>
                                                                        @else
                                                                            <strong> <a>{{ $compromi->getPartage()->nom }}
                                                                                    {{ $compromi->getPartage()->prenom }}
                                                                                    <span class="color-danger">
                                                                                        ({{ 100 - $compromi->pourcentage_agent }}
                                                                                        %) </span></a> </strong>
                                                                        @endif
                                                                    @else
                                                                        {{ $compromi->nom_agent }}
                                                            ...
                                                            @if ($compromi->je_porte_affaire == 1 && $compromi->agent_id != Auth()->user()->id)
                                                                @if ($compromi->demande_facture == 0)
                                                                    ...
                                                                    <span><a class="btn btn-default demander_facture"
                                                                            ...
                                                                            data-toggle="tooltip"
                                                                            date_vente="{{ $compromi->date_vente->format('d/m/Y') }}"
                                                                            date-vente="{{ $compromi->date_vente->format('m/d/Y') }}"
                                                        ...
                                                        <td style="">
                                                            @if ($compromi->getFactureStylimmo() != null && $compromi->getFactureStylimmo()->encaissee == true)
                                                                {{-- @if ($compromi->demande_facture == 0) --}}
                                                                <span style="color:#0ca558"> Encaissée le
                                                                    {{ $compromi->getFactureStylimmo()->date_encaissement->format('d/m/Y') }}</span>
                                                            @else
    ...
    $(function() {
        ...
        $('body').on('click', 'a.restaurer', function(e) {
            ...
            swalWithBootstrapButtons({
                title: 'Confirmez-vous la restauration de cette affaire (Mandat ' + that.attr(
                    "data-mandat") + ' )  ?',
                type: 'warning',
