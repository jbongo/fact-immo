    ...
    @php
        ...
        switch ($curent_url[1]) {
            ...
            case 'documents':
                ...
                break;
            case 'passerelles':
                $li_diffusion = 'active open';
                $li_passerelle = 'active';
                break;
            case 'passerelle':
                $li_diffusion = 'active open';
                $li_passerelle = 'active';
        ...
        if (sizeof($curent_url) > 2) {
            switch ($curent_url[2]) {
                ...
                case 'a_valider':
                    ...
                    break;
                case 'prog':
                    if ($curent_url[1] == 'diffusion') {
                        $li_diffusion_prog = 'active';
                    }
                    break;
                case 'auto':
                    if ($curent_url[1] == 'diffusion') {
                        $li_diffusion_auto = 'active';
                    }
                    break;
            ...
            <div class="nano-content">
                ...
                <ul>
                    ...
                    @if (Auth()->user()->role == 'admin')
                        ...
                        <li class="{{ $li_mandataire }}"><a href="" class="sidebar-sub-toggle"> <i
                                    class="large material-icons" style="font-size:20px;">person</i></i> Mandataires
                                <span class="sidebar-collapse-icon ti-angle-down"></span> </a>
                            <ul>
                                <li class="{{ $li_mandataire }}"><a href="{{ route('mandataire.index') }}">Gestion</a>
                                </li>
                                <li class="{{ $li_jetons }}"><a href="{{ route('mandataires.jetons') }}"
                                        class=""> Gestion des jetons </a></li>
                                <li class="{{ $li_facture_pub }}"><a href="{{ route('mandataires.facture_pub') }}"
                                        class=""> Gestion des Facts pub </a></li>
                                <li class="{{ $li_parrainage }}"><a href="{{ route('parrainage.index') }}"
                                        class=""> Gestion des Parrainages </a></li>
                        ...
                        <li class="{{ $li_contact }}"><a href="{{ route('contact.index') }}" class=""> <i
                                    class="large material-icons" style="font-size:20px;">contacts</i></i>Contacts </a>
                        </li>
                        <li class="{{ $li_fournisseurs }}"><a href="{{ route('fournisseur.index') }}" class="">
                                <i class="large material-icons" style="font-size:20px;">business</i></i>Fournisseurs
                            </a></li>
                        <li class="{{ $li_bien }}"><a href="{{ route('bien.index') }}" class=""> <i
                                    class="large material-icons" style="font-size:20px;">business</i></i>Biens </a></li>
                    @else
                    ...
                    <li class="{{ $li_diffusion }}"><a href="" class="sidebar-sub-toggle"> <i
                                class="large material-icons" style="font-size:20px;">public</i></i> Diffusion
                            <span class="sidebar-collapse-icon ti-angle-down"></span> </a>
                        <ul>
                            <li class="{{ $li_passerelle }}"><a href="{{ route('passerelle.index') }}">Passerelles</a>
                            </li>
                            <li class="{{ $li_diffusion_auto }}"><a href="{{ route('diffusion_auto.index') }}"
                                    class=""> Diffusion automatique </a></li>
                            <li class="{{ $li_diffusion_prog }}"><a href="{{ route('diffusion_prog.index') }}"
                                    class=""> Diffusion planifiée </a></li>
                    ...
                    @if (Auth()->user()->role == 'admin')
                        ...
                        <li class="{{ $li_agenda_general }}"><a href="{{ route('agendas.index') }}" class="">
                                <i class="large material-icons" style="font-size:20px;">view_agenda</i></i>Agenda </a>
                        </li>
                    @endif
                    ...
                    {{-- @endif --}}
                    @if (Auth()->user()->role == 'admin')
                        <li class="{{ $li_parametre }}"><a class="sidebar-sub-toggle"><i
                                    class="large material-icons" style="font-size:20px;">build</i> Paramètres <span
                                    class="sidebar-collapse-icon ti-angle-down"></span></a>
                            <ul>
                                ...
                                <li class=""><a href="{{ route('outil_info.index') }}"> Outils informatique
                                    </a></li>
                            ...
                            <ul>
                                ...
                                @if (session('is_switch') == true)
                                    <li><a href="{{ route('unswitch_user') }}" class="btn btn-success"><i
                                                class="ti-arrow-left"></i> <span>Retour ADMIN</span></a></li>
                                @endif
                                @if (Auth()->user()->role == 'admin')
                                    <li class="" style=" background:#e6ea9a"><a
                                            href="{{ route('stats.index', date('Y')) }}"><i
                                                class="large material-icons" style="font-size:20px;">equalizer</i>
                                            Statistiques </a></li>

                                    <li class=""><a href="{{ route('historique.index') }}" class=""> <i
                                                class="large material-icons"
                                                style="font-size:20px;">access_time</i></i>Historique </a> </li>
                                @endif
                                <li><a href="{{ route('logout') }}"
                                        onclick="event.preventDefault();
                                document.getElementById('logout-form').submit();"><i
