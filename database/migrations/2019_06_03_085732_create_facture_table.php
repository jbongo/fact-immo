...
class CreateFactureTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('factures', function (Blueprint $table) {
            ...
            $table->enum('type',['stylimmo','honoraire','pack_pub','carte_visite','parrainage','partage','partage_externe','parrainage_partage','communication','autre','forfait_entree','cci','fournisseur'])->nullable();
            ...
            $table->double('montant_ttc_deduis')->nullable();
            $table->date('date_deduction')->nullable();
            $table->string('url')->nullable();
            $table->date('date_ajout_facture')->nullable(); 
