...
dd(doubleval($request->montant_ht)."==".gettype(doubleval($request->montant_ht) )."----->".$facture->montant_ht."==".gettype($facture->montant_ht)."****** <br>".doubleval($request->montant_ht) != $facture->montant_ht);
