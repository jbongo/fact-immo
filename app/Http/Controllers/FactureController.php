...
dd(intval($request->montant_ht)."==".gettype(doubleval($request->montant_ht) )."----->".$facture->montant_ht."==".gettype($facture->montant_ht)."****** <br>".floatval($request->montant_ht) != floatval($facture->montant_ht));
