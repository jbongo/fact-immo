...
dd(intval($request->montant_ht)."==".gettype(intval($request->montant_ht) )."----->".$facture->montant_ht."==".gettype($facture->montant_ht)."****** <br>".intval($request->montant_ht) != intval($facture->montant_ht));
